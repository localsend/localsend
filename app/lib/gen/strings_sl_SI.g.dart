...
class _StringsSlSi extends Translations {
  ...
  @override
  late final _StringsReceiveTabSlSi receiveTab = _StringsReceiveTabSlSi._(_root);
  @override
  late final _StringsSendTabSlSi sendTab = _StringsSendTabSlSi._(_root);
  @override
  late final _StringsSettingsTabSlSi settingsTab = _StringsSettingsTabSlSi._(_root);
  @override
  late final _StringsTroubleshootPageSlSi troubleshootPage = _StringsTroubleshootPageSlSi._(_root);
  @override
  late final _StringsReceiveHistoryPageSlSi receiveHistoryPage = _StringsReceiveHistoryPageSlSi._(_root);
  @override
  late final _StringsApkPickerPageSlSi apkPickerPage = _StringsApkPickerPageSlSi._(_root);
  @override
  late final _StringsSelectedFilesPageSlSi selectedFilesPage = _StringsSelectedFilesPageSlSi._(_root);
  @override
  late final _StringsReceivePageSlSi receivePage = _StringsReceivePageSlSi._(_root);
  @override
  late final _StringsReceiveOptionsPageSlSi receiveOptionsPage = _StringsReceiveOptionsPageSlSi._(_root);
  @override
  late final _StringsSendPageSlSi sendPage = _StringsSendPageSlSi._(_root);
  @override
  late final _StringsProgressPageSlSi progressPage = _StringsProgressPageSlSi._(_root);
  @override
  late final _StringsWebSharePageSlSi webSharePage = _StringsWebSharePageSlSi._(_root);
  @override
  late final _StringsAboutPageSlSi aboutPage = _StringsAboutPageSlSi._(_root);
  @override
  late final _StringsDonationPageSlSi donationPage = _StringsDonationPageSlSi._(_root);
  @override
  late final _StringsChangelogPageSlSi changelogPage = _StringsChangelogPageSlSi._(_root);
  @override
  late final _StringsAliasGeneratorSlSi aliasGenerator = _StringsAliasGeneratorSlSi._(_root);
  @override
  late final _StringsDialogsSlSi dialogs = _StringsDialogsSlSi._(_root);
  @override
  late final _StringsSanitizationSlSi sanitization = _StringsSanitizationSlSi._(_root);
  @override
  late final _StringsTraySlSi tray = _StringsTraySlSi._(_root);
  @override
  late final _StringsWebSlSi web = _StringsWebSlSi._(_root);
  @override
  late final _StringsAssetPickerSlSi assetPicker = _StringsAssetPickerSlSi._(_root);
}
...
class _StringsReceiveTabSlSi extends _StringsReceiveTabEn {
  ...
  @override
  late final _StringsReceiveTabInfoBoxSlSi infoBox = _StringsReceiveTabInfoBoxSlSi._(_root);
}
...
class _StringsSendTabSlSi extends _StringsSendTabEn {
  ...
  @override
  late final _StringsSendTabSelectionSlSi selection = _StringsSendTabSelectionSlSi._(_root);
  @override
  late final _StringsSendTabPickerSlSi picker = _StringsSendTabPickerSlSi._(_root);
  @override
  ...
  @override
  late final _StringsSendTabSendModesSlSi sendModes = _StringsSendTabSendModesSlSi._(_root);
  @override
...
class _StringsSettingsTabSlSi extends _StringsSettingsTabEn {
  ...
  @override
  late final _StringsSettingsTabGeneralSlSi general = _StringsSettingsTabGeneralSlSi._(_root);
  @override
  late final _StringsSettingsTabReceiveSlSi receive = _StringsSettingsTabReceiveSlSi._(_root);
  @override
  late final _StringsSettingsTabSendSlSi send = _StringsSettingsTabSendSlSi._(_root);
  @override
  late final _StringsSettingsTabNetworkSlSi network = _StringsSettingsTabNetworkSlSi._(_root);
  @override
  late final _StringsSettingsTabOtherSlSi other = _StringsSettingsTabOtherSlSi._(_root);
  @override
...
class _StringsTroubleshootPageSlSi extends _StringsTroubleshootPageEn {
  ...
  @override
  late final _StringsTroubleshootPageFirewallSlSi firewall = _StringsTroubleshootPageFirewallSlSi._(_root);
  @override
  late final _StringsTroubleshootPageNoDiscoverySlSi noDiscovery = _StringsTroubleshootPageNoDiscoverySlSi._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionSlSi noConnection = _StringsTroubleshootPageNoConnectionSlSi._(_root);
}
...
class _StringsReceiveHistoryPageSlSi extends _StringsReceiveHistoryPageEn {
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsSlSi entryActions = _StringsReceiveHistoryPageEntryActionsSlSi._(_root);
}
...
class _StringsProgressPageSlSi extends _StringsProgressPageEn {
  ...
  @override
  late final _StringsProgressPageTotalSlSi total = _StringsProgressPageTotalSlSi._(_root);
}
...
class _StringsDialogsSlSi extends _StringsDialogsEn {
  ...
  // Translations
  @override
  late final _StringsDialogsAddFileSlSi addFile = _StringsDialogsAddFileSlSi._(_root);
  @override
  late final _StringsDialogsAddressInputSlSi addressInput = _StringsDialogsAddressInputSlSi._(_root);
  @override
  late final _StringsDialogsCancelSessionSlSi cancelSession = _StringsDialogsCancelSessionSlSi._(_root);
  @override
  late final _StringsDialogsCannotOpenFileSlSi cannotOpenFile = _StringsDialogsCannotOpenFileSlSi._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticeSlSi encryptionDisabledNotice = _StringsDialogsEncryptionDisabledNoticeSlSi._(_root);
  @override
  late final _StringsDialogsErrorDialogSlSi errorDialog = _StringsDialogsErrorDialogSlSi._(_root);
  @override
  late final _StringsDialogsFavoriteDialogSlSi favoriteDialog = _StringsDialogsFavoriteDialogSlSi._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogSlSi favoriteDeleteDialog = _StringsDialogsFavoriteDeleteDialogSlSi._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogSlSi favoriteEditDialog = _StringsDialogsFavoriteEditDialogSlSi._(_root);
  @override
  late final _StringsDialogsFileInfoSlSi fileInfo = _StringsDialogsFileInfoSlSi._(_root);
  @override
  late final _StringsDialogsFileNameInputSlSi fileNameInput = _StringsDialogsFileNameInputSlSi._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogSlSi historyClearDialog = _StringsDialogsHistoryClearDialogSlSi._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedSlSi localNetworkUnauthorized = _StringsDialogsLocalNetworkUnauthorizedSlSi._(_root);
  @override
  late final _StringsDialogsMessageInputSlSi messageInput = _StringsDialogsMessageInputSlSi._(_root);
  @override
  late final _StringsDialogsNoFilesSlSi noFiles = _StringsDialogsNoFilesSlSi._(_root);
  @override
  late final _StringsDialogsNoPermissionSlSi noPermission = _StringsDialogsNoPermissionSlSi._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformSlSi notAvailableOnPlatform = _StringsDialogsNotAvailableOnPlatformSlSi._(_root);
  @override
  late final _StringsDialogsQrSlSi qr = _StringsDialogsQrSlSi._(_root);
  @override
  late final _StringsDialogsQuickActionsSlSi quickActions = _StringsDialogsQuickActionsSlSi._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticeSlSi quickSaveNotice = _StringsDialogsQuickSaveNoticeSlSi._(_root);
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticeSlSi quickSaveFromFavoritesNotice = _StringsDialogsQuickSaveFromFavoritesNoticeSlSi._(_root);
  @override
  late final _StringsDialogsPinSlSi pin = _StringsDialogsPinSlSi._(_root);
  @override
  late final _StringsDialogsSendModeHelpSlSi sendModeHelp = _StringsDialogsSendModeHelpSlSi._(_root);
  @override
...
class _StringsSettingsTabGeneralSlSi extends _StringsSettingsTabGeneralEn {
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsSlSi brightnessOptions = _StringsSettingsTabGeneralBrightnessOptionsSlSi._(_root);
  @override
  String get color => 'Barva';
  @override
  late final _StringsSettingsTabGeneralColorOptionsSlSi colorOptions = _StringsSettingsTabGeneralColorOptionsSlSi._(_root);
  @override
  String get language => 'Jezik';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsSlSi languageOptions = _StringsSettingsTabGeneralLanguageOptionsSlSi._(_root);
  @override
...
class _StringsProgressPageTotalSlSi extends _StringsProgressPageTotalEn {
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitleSlSi title = _StringsProgressPageTotalTitleSlSi._(_root);
  @override
