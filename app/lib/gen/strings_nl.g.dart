...
class _StringsNl extends Translations {
  ...
  @override
  late final _StringsGeneralNl general = _StringsGeneralNl._(_root);
  @override
  late final _StringsReceiveTabNl receiveTab = _StringsReceiveTabNl._(_root);
  @override
  late final _StringsSendTabNl sendTab = _StringsSendTabNl._(_root);
  @override
  ...
  @override
  late final _StringsTrayNl tray = _StringsTrayNl._(_root);
  @override
  late final _StringsWebNl web = _StringsWebNl._(_root);
  @override
  late final _StringsAssetPickerNl assetPicker = _StringsAssetPickerNl._(_root);
}

// Path: general
class _StringsGeneralNl extends _StringsGeneralEn {
  _StringsGeneralNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get continueStr => 'Ga verder';
  @override
  ...
  @override
  String get noItemInClipboard => 'Niets in klembord';
}

// Path: receiveTab
class _StringsReceiveTabNl extends _StringsReceiveTabEn {
  _StringsReceiveTabNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabNl extends _StringsSendTabEn {
  _StringsSendTabNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get scan => 'Zoek naar apparaten';
  @override
...
class _StringsSettingsTabNl extends _StringsSettingsTabEn {
  _StringsSettingsTabNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNl extends _StringsTroubleshootPageEn {
  _StringsTroubleshootPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveHistoryPageNl extends _StringsReceiveHistoryPageEn {
  _StringsReceiveHistoryPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsApkPickerPageNl extends _StringsApkPickerPageEn {
  _StringsApkPickerPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get excludeSystemApps => 'Sluit systeem-apps uit';
  @override
  String get excludeAppsWithoutLaunchIntent => 'Sluit niet-startbare apps uit';
  @override
...
class _StringsSelectedFilesPageNl extends _StringsSelectedFilesPageEn {
  _StringsSelectedFilesPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsReceivePageNl extends _StringsReceivePageEn {
  _StringsReceivePageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get subTitleMessage => 'heeft je een bericht verzonden:';
  @override
  String get subTitleLink => 'heeft je een link verzonden:';
  @override
...
class _StringsReceiveOptionsPageNl extends _StringsReceiveOptionsPageEn {
  _StringsReceiveOptionsPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get saveToGalleryOff => 'Automatisch uitgezet want er zijn mappen.';
}

// Path: sendPage
class _StringsSendPageNl extends _StringsSendPageEn {
  _StringsSendPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get busy => 'De ontvanger is met een ander verzoek bezig.';
}

// Path: progressPage
class _StringsProgressPageNl extends _StringsProgressPageEn {
  _StringsProgressPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get titleSending => 'Verzenden bestanden';
  @override
  String get titleReceiving => 'Ontvangen bestanden';
  @override
...
class _StringsWebSharePageNl extends _StringsWebSharePageEn {
  _StringsWebSharePageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'Delen via weblink';
  @override
...
class _StringsAboutPageNl extends _StringsAboutPageEn {
  _StringsAboutPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsChangelogPageNl extends _StringsChangelogPageEn {
  _StringsChangelogPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsAliasGeneratorNl extends _StringsAliasGeneratorEn {
  _StringsAliasGeneratorNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNl extends _StringsDialogsEn {
  _StringsDialogsNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsTrayNl extends _StringsTrayEn {
  _StringsTrayNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsWebNl extends _StringsWebEn {
  _StringsWebNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerNl extends _StringsAssetPickerEn {
  _StringsAssetPickerNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  String get confirm => 'Bevestigen';
  @override
  String get cancel => 'Anuleren';
  @override
  String get edit => 'Bewerken';
  @override
  String get gifIndicator => 'GIF';
  @override
  String get loadFailed => 'Laadfout';
  @override
  ...
  @override
  String get goToSystemSettings => 'Ga naar het instellingen menu';
  @override
  String get accessLimitedAssets => 'Behoud beperkte toegang tot bestanden';
  @override
  String get accessiblePathName => 'Toegangkelijke bestanden';
  @override
  String get sTypeAudioLabel => 'Audio';
  @override
  String get sTypeImageLabel => 'Fotos';
  @override
  String get sTypeVideoLabel => 'Videos';
  @override
  ...
  @override
  String get sActionSwitchPathLabel => 'bestandspad aanpassen';
  @override
...
class _StringsReceiveTabInfoBoxNl extends _StringsReceiveTabInfoBoxEn {
  _StringsReceiveTabInfoBoxNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSelectionNl extends _StringsSendTabSelectionEn {
  _StringsSendTabSelectionNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabPickerNl extends _StringsSendTabPickerEn {
  _StringsSendTabPickerNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSendModesNl extends _StringsSendTabSendModesEn {
  _StringsSendTabSendModesNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get single => 'Één ontvanger';
  @override
...
class _StringsSettingsTabGeneralNl extends _StringsSettingsTabGeneralEn {
  _StringsSettingsTabGeneralNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get minimizeToTray => 'Stoppen: Minimaliseer naar systeemvak';
  @override
  String get launchAtStartup => 'Autostart na inloggen';
  @override
  String get launchMinimized => 'Autostart: Start verborgen';
  @override
...
class _StringsSettingsTabReceiveNl extends _StringsSettingsTabReceiveEn {
  _StringsSettingsTabReceiveNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get saveToGallery => 'Bewaar media in galerij';
  @override
...
class _StringsSettingsTabNetworkNl extends _StringsSettingsTabNetworkEn {
  _StringsSettingsTabNetworkNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get needRestart => 'Server herstarten om instellingen toe te passen!';
  @override
  ...
  String portWarning({required Object defaultPort}) =>
      'Je wordt mogelijk niet gedetecteerd door andere apparaten omdat je een aagepaste poort gebruikt. (standaard: ${defaultPort})';
  @override
  ...
  String multicastGroupWarning({required Object defaultMulticast}) =>
      'Je wordt mogelijk niet gedetecteerd door andere apparaten omdate je een aangepast multicast-addres gebruikt. (standaard: ${defaultMulticast})';
}
...
class _StringsTroubleshootPageFirewallNl
  ...
  @override
  String get symptom =>
      'Deze app kan bestanden verzenden naar andere apparaten maar andere apparaten kunnen geen bestanden verzenden naar dit apparaat.';
  @override
  String solution({required Object port}) =>
      'Dit is hoogstwaarschijnlijk een firewall probleem. Je kan dit oplossen door inkomende verbindingen (UDP en TCP) toe te staan op poort ${port}.';
  @override
...
class _StringsProgressPageTotalNl extends _StringsProgressPageTotalEn {
  _StringsProgressPageTotalNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddFileNl extends _StringsDialogsAddFileEn {
  _StringsDialogsAddFileNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddressInputNl extends _StringsDialogsAddressInputEn {
  _StringsDialogsAddressInputNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'Adres ingeven';
  @override
  String get hashtag => 'Hashtag';
  @override
  String get ip => 'IP Adres';
  @override
  String get recentlyUsed => 'Recent gebruikt: ';
}

// Path: dialogs.cancelSession
class _StringsDialogsCancelSessionNl extends _StringsDialogsCancelSessionEn {
  _StringsDialogsCancelSessionNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCannotOpenFileNl extends _StringsDialogsCannotOpenFileEn {
  _StringsDialogsCannotOpenFileNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsErrorDialogNl extends _StringsDialogsErrorDialogEn {
  _StringsDialogsErrorDialogNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDialogNl extends _StringsDialogsFavoriteDialogEn {
  _StringsDialogsFavoriteDialogNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'Voorkeuren';
  @override
  String get noFavorites => 'Geen Favoriete Apparaten';
  @override
...
class _StringsDialogsFavoriteEditDialogNl
  ...
  // Translations
  @override
  String get titleAdd => 'Aan Favorieten toevoegen';
  @override
  String get titleEdit => 'Aanpassen';
  @override
...
class _StringsDialogsFileInfoNl extends _StringsDialogsFileInfoEn {
  _StringsDialogsFileInfoNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get size => 'Groote:';
  @override
  String get sender => 'Verzender:';
  @override
  String get time => 'Tijdstip:';
}

// Path: dialogs.fileNameInput
class _StringsDialogsFileNameInputNl extends _StringsDialogsFileNameInputEn {
  _StringsDialogsFileNameInputNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'Voer bestandsnaam in';
  @override
...
class _StringsDialogsHistoryClearDialogNl
  ...
  @override
  String get content => 'Weet u zeker dat u de geschiedenis wilt wissen?';
}
...
class _StringsDialogsLocalNetworkUnauthorizedNl
  ...
  String get description =>
      'LocalSend kan geen andere apparaten op uw netwerk vinden zonder de juiste rechten voor netwerktoegang te hebben verkregen. Stel deze correct in in het instellingen menu.';
  @override
...
class _StringsDialogsMessageInputNl extends _StringsDialogsMessageInputEn {
  _StringsDialogsMessageInputNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'Typ bericht';
  @override
  String get multiline => 'Meerdere lijnen';
}

// Path: dialogs.noFiles
class _StringsDialogsNoFilesNl extends _StringsDialogsNoFilesEn {
  _StringsDialogsNoFilesNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content => 'Selecteer minstens één bestand.';
}

// Path: dialogs.noPermission
class _StringsDialogsNoPermissionNl extends _StringsDialogsNoPermissionEn {
  _StringsDialogsNoPermissionNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNotAvailableOnPlatformNl
  ...
  @override
  String get content => 'Deze functie is enkel beschikbaar op:';
}

// Path: dialogs.qr
class _StringsDialogsQrNl extends _StringsDialogsQrEn {
  _StringsDialogsQrNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickActionsNl extends _StringsDialogsQuickActionsEn {
  _StringsDialogsQuickActionsNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get padZero => 'Met nullen aanvullen';
  @override
  String get sortBeforeCount => 'Vooraf alfabetisch sorteren';
  @override
...
class _StringsDialogsQuickSaveNoticeNl
  ...
  @override
  String get content =>
      'Bestandsoverdrachten worden automatisch geaccepteerd. Houd er rekening mee dat iedereen in het lokale netwerk je bestanden kan sturen.';
}

// Path: dialogs.sendModeHelp
class _StringsDialogsSendModeHelpNl extends _StringsDialogsSendModeHelpEn {
  _StringsDialogsSendModeHelpNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalTitleNl
  ...
  // Translations
  @override
  String sending({required Object time}) => 'Totale vooruitgang (${time})';
  @override
  String get finishedError => 'Afgerond met een foutmelding';
  @override
  String get canceledSender => 'Geannuleerd door de verzender';
  @override
  String get canceledReceiver => 'Geannuleerd door de ontvanger';
}
