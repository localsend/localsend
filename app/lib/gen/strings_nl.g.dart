...
class _StringsNl extends Translations {
  ...
  @override
  late final _StringsDonationPageNl donationPage =
      _StringsDonationPageNl._(_root);
  @override
  ...
  @override
  late final _StringsSanitizationNl sanitization =
      _StringsSanitizationNl._(_root);
  @override
...
class _StringsSendTabNl extends _StringsSendTabEn {
  ...
  String get shareIntentInfo =>
      'Je kunt ook de functie \'Delen\' van je mobiele apparaat gebruiken om gemakkelijker bestanden te selecteren.';
  @override
  ...
  @override
  String get help =>
      'Zorg ervoor dat de ontvanger is verbonden met hetzelfde wifi-netwerk.';
  @override
...
class _StringsSettingsTabNl extends _StringsSettingsTabEn {
  ...
  @override
  late final _StringsSettingsTabSendNl send =
      _StringsSettingsTabSendNl._(_root);
  @override
  late final _StringsSettingsTabNetworkNl network =
      _StringsSettingsTabNetworkNl._(_root);
  @override
  late final _StringsSettingsTabOtherNl other =
      _StringsSettingsTabOtherNl._(_root);
  @override
...
class _StringsTroubleshootPageNl extends _StringsTroubleshootPageEn {
  ...
  @override
  String get subTitle =>
      'Werkt de app niet zoals verwacht? Op deze pagina vind je oplossingen voor veelvoorkomende problemen.';
  @override
  ...
  @override
  late final _StringsTroubleshootPageNoDiscoveryNl noDiscovery =
      _StringsTroubleshootPageNoDiscoveryNl._(_root);
  @override
...
class _StringsReceiveOptionsPageNl extends _StringsReceiveOptionsPageEn {
  ...
  String get saveToGalleryOff =>
      'Automatisch uitgezet omdat er mappen bij zitten.';
}
...
class _StringsWebSharePageNl extends _StringsWebSharePageEn {
  ...
  @override
  String get error =>
      'Er is een fout opgetreden bij het starten van de server.';
  @override
  ...
  String get encryptionHint =>
      'LocalSend maakt gebruik van een zelfondertekend certificaat. Je moet dit accepteren in je browser.';
  @override
...
class _StringsDonationPageNl extends _StringsDonationPageEn {
  _StringsDonationPageNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNl extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticeNl
      quickSaveFromFavoritesNotice =
      _StringsDialogsQuickSaveFromFavoritesNoticeNl._(_root);
  @override
  late final _StringsDialogsPinNl pin = _StringsDialogsPinNl._(_root);
  @override
  late final _StringsDialogsSendModeHelpNl sendModeHelp =
      _StringsDialogsSendModeHelpNl._(_root);
  @override
  late final _StringsDialogsZoomNl zoom = _StringsDialogsZoomNl._(_root);
}

// Path: sanitization
class _StringsSanitizationNl extends _StringsSanitizationEn {
  _StringsSanitizationNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerNl extends _StringsAssetPickerEn {
  ...
  String get unableToAccessAll =>
      'Geen toegang tot alle bestanden op het apparaat';
  @override
  String get viewingLimitedAssetsTip =>
      'De app heeft beperkte toegang tot bestanden.';
  @override
  String get changeAccessibleLimitedAssets =>
      'Toegankelijke bestanden aanpassen';
  @override
...
class _StringsSettingsTabGeneralNl extends _StringsSettingsTabGeneralEn {
  ...
  String get saveWindowPlacementWindows =>
      'Afsluiten: vensterindeling behouden';
  @override
  String get minimizeToTray =>
      'Sluiten: minimaliseren naar systeemvak/menubalk';
  @override
...
class _StringsSettingsTabSendNl extends _StringsSettingsTabSendEn {
  _StringsSettingsTabSendNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  String get shareViaLinkAutoAccept =>
      'Automatisch verzoeken goedkeuren in modus \'Delen via link\'';
}
...
class _StringsSettingsTabNetworkNl extends _StringsSettingsTabNetworkEn {
  ...
  String get needRestart =>
      'Start de server opnieuw op om de instellingen toe te passen.';
  @override
...
class _StringsSettingsTabOtherNl extends _StringsSettingsTabOtherEn {
  _StringsSettingsTabOtherNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNoDiscoveryNl
    extends _StringsTroubleshootPageNoDiscoveryEn {
  _StringsTroubleshootPageNoDiscoveryNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNoConnectionNl
  ...
  @override
  String get symptom =>
      'Beide apparaten kunnen elkaar niet vinden en kunnen ook geen bestanden delen.';
  @override
  String get solution =>
...
class _StringsDialogsCannotOpenFileNl extends _StringsDialogsCannotOpenFileEn {
  ...
  String content({required Object file}) =>
      'Het bestand \'${file}\' kan niet worden geopend. Het is mogelijk verplaatst, hernoemd of verwijderd.';
}
...
class _StringsDialogsFavoriteDeleteDialogNl
  ...
  String content({required Object name}) =>
      'Wil je \'${name}\' uit je favorieten verwijderen?';
}
...
class _StringsDialogsNoPermissionNl extends _StringsDialogsNoPermissionEn {
  ...
  @override
  String get content =>
      'Je hebt de benodigde rechten niet verleend. Verleen deze in de instellingen.';
}
...
class _StringsDialogsQuickSaveFromFavoritesNoticeNl
    extends _StringsDialogsQuickSaveFromFavoritesNoticeEn {
  _StringsDialogsQuickSaveFromFavoritesNoticeNl._(_StringsNl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Bestandsverzoeken van je favoriete apparaten worden nu automatisch geaccepteerd.';
}

// Path: dialogs.pin
class _StringsDialogsPinNl extends _StringsDialogsPinEn {
  _StringsDialogsPinNl._(_StringsNl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpNl extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get single =>
      'Bestanden naar één ontvanger verzenden. De selectie wordt na de bestandsoverdracht gewist.';
  @override
  String get multiple =>
      'Bestanden naar meerdere ontvangers verzenden. De selectie blijft na de bestandsoverdracht behouden.';
  @override
  String get link =>
      'Ontvangers die LocalSend niet hebben geïnstalleerd kunnen de bestanden downloaden door de link in hun browser te openen.';
}

// Path: dialogs.zoom
class _StringsDialogsZoomNl extends _StringsDialogsZoomEn {
  _StringsDialogsZoomNl._(_StringsNl root)
      : this._root = root,
        super._(root);
