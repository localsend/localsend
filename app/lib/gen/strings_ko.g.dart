...
class _StringsKo extends Translations {
  ...
  @override
  late final _StringsGeneralKo general = _StringsGeneralKo._(_root);
  @override
  late final _StringsReceiveTabKo receiveTab = _StringsReceiveTabKo._(_root);
  @override
  late final _StringsSendTabKo sendTab = _StringsSendTabKo._(_root);
  @override
  ...
  @override
  late final _StringsSanitizationKo sanitization =
      _StringsSanitizationKo._(_root);
  @override
  late final _StringsTrayKo tray = _StringsTrayKo._(_root);
  @override
  late final _StringsWebKo web = _StringsWebKo._(_root);
  @override
  late final _StringsAssetPickerKo assetPicker = _StringsAssetPickerKo._(_root);
}

// Path: general
class _StringsGeneralKo extends _StringsGeneralEn {
  _StringsGeneralKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  String get copy => '복사';
  @override
  String get copiedToClipboard => '클립보드에 복사하였습니다';
  @override
  ...
  String get save => '저장';
  @override
  String get unchanged => '변경 안됨';
  @override
  String get unknown => '알 수 없음';
  @override
  String get noItemInClipboard => '클립보드에 항목이 없습니다';
}

// Path: receiveTab
class _StringsReceiveTabKo extends _StringsReceiveTabEn {
  _StringsReceiveTabKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabKo extends _StringsSendTabEn {
  _StringsSendTabKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get nearbyDevices => '근처의 기기';
  @override
  ...
  @override
  String get placeItems => '드롭해서 공유';
}

// Path: settingsTab
class _StringsSettingsTabKo extends _StringsSettingsTabEn {
  _StringsSettingsTabKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageKo extends _StringsTroubleshootPageEn {
  _StringsTroubleshootPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get subTitle => '이 앱이 예상대로 작동하지 않나요? 여기에서 일반적인 해결 방법을 찾을 수 있습니다.';
  @override
  String get solution => '해결 방법:';
  @override
  ...
  @override
  late final _StringsTroubleshootPageNoDiscoveryKo noDiscovery =
      _StringsTroubleshootPageNoDiscoveryKo._(_root);
  @override
...
class _StringsReceiveHistoryPageKo extends _StringsReceiveHistoryPageEn {
  _StringsReceiveHistoryPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsApkPickerPageKo extends _StringsApkPickerPageEn {
  _StringsApkPickerPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsSelectedFilesPageKo extends _StringsSelectedFilesPageEn {
  _StringsSelectedFilesPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsReceivePageKo extends _StringsReceivePageEn {
  _StringsReceivePageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveOptionsPageKo extends _StringsReceiveOptionsPageEn {
  _StringsReceiveOptionsPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get saveToGalleryOff => '디렉토리가 있어 자동으로 꺼집니다.';
}

// Path: sendPage
class _StringsSendPageKo extends _StringsSendPageEn {
  _StringsSendPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageKo extends _StringsProgressPageEn {
  ...
  // Translations
  @override
  String get titleSending => '파일을 보내는 중';
  @override
  String get titleReceiving => '파일을 받는 중';
  @override
...
class _StringsWebSharePageKo extends _StringsWebSharePageEn {
  _StringsWebSharePageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get encryptionHint => 'LocalSend는 자체 서명된 인증서를 사용합니다. 브라우저에서 수락해야 합니다.';
  @override
  String pendingRequests({required Object n}) => '대기중인 요청: ${n}';
}

// Path: aboutPage
class _StringsAboutPageKo extends _StringsAboutPageEn {
  _StringsAboutPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'LocalSend에 대해';
  @override
  ...
  @override
  String get translators => '번역자';
}

// Path: donationPage
class _StringsDonationPageKo extends _StringsDonationPageEn {
  _StringsDonationPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsChangelogPageKo extends _StringsChangelogPageEn {
  _StringsChangelogPageKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => '업데이트 이력';
}

// Path: aliasGenerator
class _StringsAliasGeneratorKo extends _StringsAliasGeneratorEn {
  _StringsAliasGeneratorKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsKo extends _StringsDialogsEn {
  _StringsDialogsKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsDialogsPinKo pin = _StringsDialogsPinKo._(_root);
  @override
  late final _StringsDialogsSendModeHelpKo sendModeHelp =
      _StringsDialogsSendModeHelpKo._(_root);
  @override
  late final _StringsDialogsZoomKo zoom = _StringsDialogsZoomKo._(_root);
}

// Path: sanitization
class _StringsSanitizationKo extends _StringsSanitizationEn {
  _StringsSanitizationKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsTrayKo extends _StringsTrayEn {
  _StringsTrayKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get close => 'LocalSend 종료';
}

// Path: web
class _StringsWebKo extends _StringsWebEn {
  _StringsWebKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerKo extends _StringsAssetPickerEn {
  _StringsAssetPickerKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get viewingLimitedAssetsTip => '앱에서 접근 가능한 파일과 앨범만 볼 수 있습니다.';
  @override
...
class _StringsReceiveTabInfoBoxKo extends _StringsReceiveTabInfoBoxEn {
  _StringsReceiveTabInfoBoxKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSelectionKo extends _StringsSendTabSelectionEn {
  _StringsSendTabSelectionKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabPickerKo extends _StringsSendTabPickerEn {
  _StringsSendTabPickerKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSendModesKo extends _StringsSendTabSendModesEn {
  _StringsSendTabSendModesKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get single => '단일 수신자';
  @override
  String get multiple => '다중 수신자';
  @override
...
class _StringsSettingsTabGeneralKo extends _StringsSettingsTabGeneralEn {
  _StringsSettingsTabGeneralKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabReceiveKo extends _StringsSettingsTabReceiveEn {
  _StringsSettingsTabReceiveKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get saveToGallery => '미디어를 갤러리에 저장';
  @override
  String get saveToHistory => '히스토리에 저장';
}

// Path: settingsTab.send
class _StringsSettingsTabSendKo extends _StringsSettingsTabSendEn {
  _StringsSettingsTabSendKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  String get title => '전송';
  @override
  String get shareViaLinkAutoAccept => '링크 공유: 자동 수락';
}

// Path: settingsTab.network
class _StringsSettingsTabNetworkKo extends _StringsSettingsTabNetworkEn {
  _StringsSettingsTabNetworkKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get needRestart => '서버를 재시작해야 변경된 설정이 반영됩니다';
  @override
  ...
  String multicastGroupWarning({required Object defaultMulticast}) =>
      '사용자 지정 멀티캐스트 주소를 사용하고 있기 때문에 다른 기기에서 감지되지 않을 수 있습니다. (기본값: ${defaultMulticast})';
}

// Path: settingsTab.other
class _StringsSettingsTabOtherKo extends _StringsSettingsTabOtherEn {
  _StringsSettingsTabOtherKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  String get title => '기타';
  @override
  String get support => 'LocalSend 지원';
  @override
...
class _StringsTroubleshootPageNoDiscoveryKo
    extends _StringsTroubleshootPageNoDiscoveryEn {
  _StringsTroubleshootPageNoDiscoveryKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get symptom => '현재 기기에서 다른 기기를 찾을 수 없습니다.';
  @override
  String get solution =>
      '모든 장치가 동일한 Wi-Fi 네트워크에 연결되어 있고 동일한 설정(포트, 멀티캐스트 주소, 암호화)을 공유하는지 확인하세요. 기기의 IP 주소를 수동으로 입력해 볼 수도 있습니다. 이 방법이 작동하면, 해당 기기를 즐겨찾기에 추가하여 앞으로 자동으로 검색될 수 있도록 해 보세요.';
}
...
class _StringsTroubleshootPageNoConnectionKo
  ...
  // Translations
  @override
  String get symptom => '두 기기 모두 서로를 검색하거나 파일을 공유할 수 없습니다.';
  @override
  String get solution =>
      '양쪽 모두에 문제가 있나요? 두 기기가 동일한 Wi-Fi 네트워크에 연결되어 있고 동일한 구성 (포트, 멀티캐스트 주소, 암호화)를 공유하는지 확인해야 합니다. Wi-Fi가 참가자 간 통신을 허용하지 않을 수도 있습니다. 이 경우 라우터에서 해당 옵션을 활성화해야 합니다.';
}
...
class _StringsProgressPageTotalKo extends _StringsProgressPageTotalEn {
  _StringsProgressPageTotalKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddFileKo extends _StringsDialogsAddFileEn {
  _StringsDialogsAddFileKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => '선택 목록에 추가';
  @override
  String get content => '무엇을 추가할까요?';
}

// Path: dialogs.addressInput
class _StringsDialogsAddressInputKo extends _StringsDialogsAddressInputEn {
  _StringsDialogsAddressInputKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCancelSessionKo extends _StringsDialogsCancelSessionEn {
  _StringsDialogsCancelSessionKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCannotOpenFileKo extends _StringsDialogsCannotOpenFileEn {
  _StringsDialogsCannotOpenFileKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsErrorDialogKo extends _StringsDialogsErrorDialogEn {
  _StringsDialogsErrorDialogKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDialogKo extends _StringsDialogsFavoriteDialogEn {
  _StringsDialogsFavoriteDialogKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDeleteDialogKo
  ...
  // Translations
  @override
  String get title => '즐겨찾기에서 삭제';
  @override
  String content({required Object name}) => '정말 "${name}" 즐겨찾기에서 삭제할까요?';
}
...
class _StringsDialogsFileInfoKo extends _StringsDialogsFileInfoEn {
  _StringsDialogsFileInfoKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileNameInputKo extends _StringsDialogsFileNameInputEn {
  _StringsDialogsFileNameInputKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsMessageInputKo extends _StringsDialogsMessageInputEn {
  _StringsDialogsMessageInputKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => '메시지를 입력하세요';
  @override
  String get multiline => '여러줄';
}

// Path: dialogs.noFiles
class _StringsDialogsNoFilesKo extends _StringsDialogsNoFilesEn {
  _StringsDialogsNoFilesKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => '파일이 선택되지 않았습니다';
  @override
...
class _StringsDialogsNoPermissionKo extends _StringsDialogsNoPermissionEn {
  _StringsDialogsNoPermissionKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content => '필요한 권한을 허용하지 않았습니다. 설정에서 허용해주세요.';
}
...
class _StringsDialogsNotAvailableOnPlatformKo
  ...
  @override
  String get content => '이 기능은 다음 플랫폼에서만 사용 가능합니다:';
}

// Path: dialogs.qr
class _StringsDialogsQrKo extends _StringsDialogsQrEn {
  _StringsDialogsQrKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickActionsKo extends _StringsDialogsQuickActionsEn {
  _StringsDialogsQuickActionsKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsPinKo extends _StringsDialogsPinEn {
  _StringsDialogsPinKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpKo extends _StringsDialogsSendModeHelpEn {
  _StringsDialogsSendModeHelpKo._(_StringsKo root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get single => '파일을 한 명의 수신자에게 보냅니다. 파일 전송이 완료되면 선택이 지워집니다.';
  @override
...
class _StringsDialogsZoomKo extends _StringsDialogsZoomEn {
  _StringsDialogsZoomKo._(_StringsKo root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalTitleKo
  ...
  String sending({required Object time, required Object speed}) =>
      '진행 시간 (${time}) (${speed})';
  @override
  String get finishedError => '에러로 인해 종료되었습니다';
  @override
  String get canceledSender => '보내는 사람이 취소했습니다';
  @override
  String get canceledReceiver => '받는 사람이 취소했습니다';
}
