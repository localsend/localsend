...
class _StringsSendTabIt extends _StringsSendTabEn {
  ...
  String get shareIntentInfo =>
      'Puoi anche usare la funzione "Condividi" del dispositivo mobile per selezionare più facilmente i file.';
  @override
  ...
  @override
  String get help =>
      'Assicurati che il destinatario desiderato si trovi sulla stessa rete Wi-Fi.';
  @override
...
class _StringsTroubleshootPageIt extends _StringsTroubleshootPageEn {
  ...
  @override
  String get subTitle =>
      'L\'app non funziona come previsto? Qui puoi trovare le soluzioni più comuni.';
  @override
  ...
  @override
  late final _StringsTroubleshootPageNoDiscoveryIt noDiscovery =
      _StringsTroubleshootPageNoDiscoveryIt._(_root);
  @override
...
class _StringsReceiveOptionsPageIt extends _StringsReceiveOptionsPageEn {
  ...
  String get saveToGalleryOff =>
      'Disattivato automaticamente in presenza di cartelle.';
}
...
class _StringsWebSharePageIt extends _StringsWebSharePageEn {
  ...
  String get encryptionHint =>
      'LocalSend utilizza un certificato autofirmato. Devi accettarlo nel browser.';
  @override
...
class _StringsDialogsIt extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticeIt
      quickSaveFromFavoritesNotice =
      _StringsDialogsQuickSaveFromFavoritesNoticeIt._(_root);
  @override
  late final _StringsDialogsPinIt pin = _StringsDialogsPinIt._(_root);
  @override
...
class _StringsAssetPickerIt extends _StringsAssetPickerEn {
  ...
  String get viewingLimitedAssetsTip =>
      'Visualizza solo file e album accessibili dall\'app.';
  @override
  String get changeAccessibleLimitedAssets =>
      'Clicca per aggiornare i file accessibili';
  @override
...
class _StringsSettingsTabGeneralIt extends _StringsSettingsTabGeneralEn {
  ...
  String get saveWindowPlacement =>
      'Salva la posizione della finestra all\'uscita';
  @override
  String get saveWindowPlacementWindows =>
      'Salva la posizione della finestra alla chiusura';
  @override
...
class _StringsSettingsTabSendIt extends _StringsSettingsTabSendEn {
  ...
  String get shareViaLinkAutoAccept =>
      'Accetta automaticamente le richieste in modalità "Condividi tramite link"';
}
...
class _StringsTroubleshootPageNoDiscoveryIt
    extends _StringsTroubleshootPageNoDiscoveryEn {
  _StringsTroubleshootPageNoDiscoveryIt._(_StringsIt root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get symptom =>
      'Questo dispositivo non riesce a rilevare altri dispositivi.';
  @override
  String get solution =>
...
class _StringsTroubleshootPageNoConnectionIt
  ...
  @override
  String get symptom =>
      'Entrambi i dispositivi non sono in grado di riconoscersi a vicenda né di condividere file.';
  @override
  String get solution =>
...
class _StringsDialogsCannotOpenFileIt extends _StringsDialogsCannotOpenFileEn {
  ...
  String content({required Object file}) =>
      'Impossibile aprire "${file}". Hai spostato, rinominato o eliminato il file?';
}
...
class _StringsDialogsFavoriteDeleteDialogIt
  ...
  String content({required Object name}) =>
      'Sei davvero sicuro di voler rimuovere "${name}" dai preferiti?';
}
...
class _StringsDialogsNoPermissionIt extends _StringsDialogsNoPermissionEn {
  ...
  @override
  String get content =>
      'Non hai concesso le autorizzazioni necessarie. Si prega di concederle nelle impostazioni.';
}
...
class _StringsDialogsQuickSaveFromFavoritesNoticeIt
    extends _StringsDialogsQuickSaveFromFavoritesNoticeEn {
  _StringsDialogsQuickSaveFromFavoritesNoticeIt._(_StringsIt root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Le richieste di file ora vengono accettate automaticamente dai dispositivi presenti nell\'elenco dei preferiti.';
}

// Path: dialogs.pin
class _StringsDialogsPinIt extends _StringsDialogsPinEn {
  _StringsDialogsPinIt._(_StringsIt root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpIt extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get single =>
      'Invia file a un destinatario. Gli elementi saranno deselezionati dopo il trasferimento dei file.';
  @override
  String get multiple =>
      'Invia file a più destinatari. Gli elementi non saranno deselezionati dopo il trasferimento dei file.';
  @override
  String get link =>
...
class _StringsProgressPageTotalTitleIt
  ...
  String sending({required Object time, required Object speed}) =>
      'Progresso complessivo (${time}) (${speed})';
  @override
