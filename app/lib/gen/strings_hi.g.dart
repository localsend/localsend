...
class _StringsHi extends Translations {
  ...
  @override
  late final _StringsTroubleshootPageHi troubleshootPage = _StringsTroubleshootPageHi._(_root);
  @override
  late final _StringsReceiveHistoryPageHi receiveHistoryPage = _StringsReceiveHistoryPageHi._(_root);
  @override
  late final _StringsApkPickerPageHi apkPickerPage = _StringsApkPickerPageHi._(_root);
  @override
  late final _StringsSelectedFilesPageHi selectedFilesPage = _StringsSelectedFilesPageHi._(_root);
  @override
  late final _StringsReceivePageHi receivePage = _StringsReceivePageHi._(_root);
  @override
  late final _StringsReceiveOptionsPageHi receiveOptionsPage = _StringsReceiveOptionsPageHi._(_root);
  @override
  late final _StringsSendPageHi sendPage = _StringsSendPageHi._(_root);
  @override
  late final _StringsProgressPageHi progressPage = _StringsProgressPageHi._(_root);
  @override
  late final _StringsWebSharePageHi webSharePage = _StringsWebSharePageHi._(_root);
  @override
  late final _StringsAboutPageHi aboutPage = _StringsAboutPageHi._(_root);
  @override
  late final _StringsDonationPageHi donationPage = _StringsDonationPageHi._(_root);
  @override
  late final _StringsChangelogPageHi changelogPage = _StringsChangelogPageHi._(_root);
  @override
  late final _StringsAliasGeneratorHi aliasGenerator = _StringsAliasGeneratorHi._(_root);
  @override
  late final _StringsDialogsHi dialogs = _StringsDialogsHi._(_root);
  @override
  late final _StringsSanitizationHi sanitization = _StringsSanitizationHi._(_root);
  @override
...
class _StringsReceiveTabHi extends _StringsReceiveTabEn {
  ...
  @override
  late final _StringsReceiveTabInfoBoxHi infoBox = _StringsReceiveTabInfoBoxHi._(_root);
}
...
class _StringsSendTabHi extends _StringsSendTabEn {
  ...
  @override
  late final _StringsSendTabSelectionHi selection = _StringsSendTabSelectionHi._(_root);
  @override
  ...
  @override
  late final _StringsSendTabSendModesHi sendModes = _StringsSendTabSendModesHi._(_root);
  @override
...
class _StringsSettingsTabHi extends _StringsSettingsTabEn {
  ...
  @override
  late final _StringsSettingsTabGeneralHi general = _StringsSettingsTabGeneralHi._(_root);
  @override
  late final _StringsSettingsTabReceiveHi receive = _StringsSettingsTabReceiveHi._(_root);
  @override
  late final _StringsSettingsTabSendHi send = _StringsSettingsTabSendHi._(_root);
  @override
  late final _StringsSettingsTabNetworkHi network = _StringsSettingsTabNetworkHi._(_root);
  @override
  late final _StringsSettingsTabOtherHi other = _StringsSettingsTabOtherHi._(_root);
  @override
...
class _StringsTroubleshootPageHi extends _StringsTroubleshootPageEn {
  ...
  @override
  late final _StringsTroubleshootPageFirewallHi firewall = _StringsTroubleshootPageFirewallHi._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionHi noConnection = _StringsTroubleshootPageNoConnectionHi._(_root);
}
...
class _StringsReceiveHistoryPageHi extends _StringsReceiveHistoryPageEn {
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsHi entryActions = _StringsReceiveHistoryPageEntryActionsHi._(_root);
}
...
class _StringsProgressPageHi extends _StringsProgressPageEn {
  ...
  @override
  late final _StringsProgressPageTotalHi total = _StringsProgressPageTotalHi._(_root);
}
...
class _StringsDialogsHi extends _StringsDialogsEn {
  ...
  // Translations
  @override
  late final _StringsDialogsAddFileHi addFile = _StringsDialogsAddFileHi._(_root);
  @override
  late final _StringsDialogsAddressInputHi addressInput = _StringsDialogsAddressInputHi._(_root);
  @override
  late final _StringsDialogsCancelSessionHi cancelSession = _StringsDialogsCancelSessionHi._(_root);
  @override
  late final _StringsDialogsCannotOpenFileHi cannotOpenFile = _StringsDialogsCannotOpenFileHi._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticeHi encryptionDisabledNotice = _StringsDialogsEncryptionDisabledNoticeHi._(_root);
  @override
  late final _StringsDialogsErrorDialogHi errorDialog = _StringsDialogsErrorDialogHi._(_root);
  @override
  late final _StringsDialogsFavoriteDialogHi favoriteDialog = _StringsDialogsFavoriteDialogHi._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogHi favoriteDeleteDialog = _StringsDialogsFavoriteDeleteDialogHi._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogHi favoriteEditDialog = _StringsDialogsFavoriteEditDialogHi._(_root);
  @override
  late final _StringsDialogsFileInfoHi fileInfo = _StringsDialogsFileInfoHi._(_root);
  @override
  late final _StringsDialogsFileNameInputHi fileNameInput = _StringsDialogsFileNameInputHi._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogHi historyClearDialog = _StringsDialogsHistoryClearDialogHi._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedHi localNetworkUnauthorized = _StringsDialogsLocalNetworkUnauthorizedHi._(_root);
  @override
  late final _StringsDialogsMessageInputHi messageInput = _StringsDialogsMessageInputHi._(_root);
  @override
  late final _StringsDialogsNoFilesHi noFiles = _StringsDialogsNoFilesHi._(_root);
  @override
  late final _StringsDialogsNoPermissionHi noPermission = _StringsDialogsNoPermissionHi._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformHi notAvailableOnPlatform = _StringsDialogsNotAvailableOnPlatformHi._(_root);
  @override
  late final _StringsDialogsQrHi qr = _StringsDialogsQrHi._(_root);
  @override
  late final _StringsDialogsQuickActionsHi quickActions = _StringsDialogsQuickActionsHi._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticeHi quickSaveNotice = _StringsDialogsQuickSaveNoticeHi._(_root);
  @override
  late final _StringsDialogsPinHi pin = _StringsDialogsPinHi._(_root);
  @override
  late final _StringsDialogsSendModeHelpHi sendModeHelp = _StringsDialogsSendModeHelpHi._(_root);
  @override
...
class _StringsSettingsTabGeneralHi extends _StringsSettingsTabGeneralEn {
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsHi brightnessOptions = _StringsSettingsTabGeneralBrightnessOptionsHi._(_root);
  @override
  String get color => 'रंग';
  @override
  late final _StringsSettingsTabGeneralColorOptionsHi colorOptions = _StringsSettingsTabGeneralColorOptionsHi._(_root);
  @override
  String get language => 'भाषा';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsHi languageOptions = _StringsSettingsTabGeneralLanguageOptionsHi._(_root);
  @override
...
class _StringsProgressPageTotalHi extends _StringsProgressPageTotalEn {
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitleHi title = _StringsProgressPageTotalTitleHi._(_root);
  @override
