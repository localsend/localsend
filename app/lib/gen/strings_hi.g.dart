...
class _StringsHi extends Translations {
  ...
  @override
  late final _StringsGeneralHi general = _StringsGeneralHi._(_root);
  @override
  late final _StringsReceiveTabHi receiveTab = _StringsReceiveTabHi._(_root);
  @override
  late final _StringsSendTabHi sendTab = _StringsSendTabHi._(_root);
  @override
  late final _StringsSettingsTabHi settingsTab = _StringsSettingsTabHi._(_root);
  @override
  late final _StringsTroubleshootPageHi troubleshootPage =
      _StringsTroubleshootPageHi._(_root);
  @override
  late final _StringsReceiveHistoryPageHi receiveHistoryPage =
      _StringsReceiveHistoryPageHi._(_root);
  @override
  late final _StringsApkPickerPageHi apkPickerPage =
      _StringsApkPickerPageHi._(_root);
  @override
  late final _StringsSelectedFilesPageHi selectedFilesPage =
      _StringsSelectedFilesPageHi._(_root);
  @override
  late final _StringsReceivePageHi receivePage = _StringsReceivePageHi._(_root);
  @override
  late final _StringsReceiveOptionsPageHi receiveOptionsPage =
      _StringsReceiveOptionsPageHi._(_root);
  @override
  late final _StringsSendPageHi sendPage = _StringsSendPageHi._(_root);
  @override
  late final _StringsProgressPageHi progressPage =
      _StringsProgressPageHi._(_root);
  @override
  late final _StringsWebSharePageHi webSharePage =
      _StringsWebSharePageHi._(_root);
  @override
  late final _StringsAboutPageHi aboutPage = _StringsAboutPageHi._(_root);
  @override
  late final _StringsDonationPageHi donationPage =
      _StringsDonationPageHi._(_root);
  @override
  late final _StringsChangelogPageHi changelogPage =
      _StringsChangelogPageHi._(_root);
  @override
  late final _StringsAliasGeneratorHi aliasGenerator =
      _StringsAliasGeneratorHi._(_root);
  @override
  late final _StringsDialogsHi dialogs = _StringsDialogsHi._(_root);
  @override
  late final _StringsSanitizationHi sanitization =
      _StringsSanitizationHi._(_root);
  @override
  late final _StringsTrayHi tray = _StringsTrayHi._(_root);
  @override
  late final _StringsWebHi web = _StringsWebHi._(_root);
  @override
  late final _StringsAssetPickerHi assetPicker = _StringsAssetPickerHi._(_root);
}

// Path: general
class _StringsGeneralHi extends _StringsGeneralEn {
  _StringsGeneralHi._(_StringsHi root)
      : this._root = root,
        super._(root);

  @override
  final _StringsHi _root; // ignore: unused_field
...
class _StringsReceiveTabHi extends _StringsReceiveTabEn {
  _StringsReceiveTabHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsReceiveTabInfoBoxHi infoBox =
      _StringsReceiveTabInfoBoxHi._(_root);
}

// Path: sendTab
class _StringsSendTabHi extends _StringsSendTabEn {
  _StringsSendTabHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSendTabSelectionHi selection =
      _StringsSendTabSelectionHi._(_root);
  @override
  late final _StringsSendTabPickerHi picker = _StringsSendTabPickerHi._(_root);
  @override
  String get shareIntentInfo =>
      'आप अपने मोबाइल डिवाइस की "शेयर" सुविधा का उपयोग करके फाइलें अधिक आसानी से चुन सकते हैं।';
  @override
  ...
  @override
  late final _StringsSendTabSendModesHi sendModes =
      _StringsSendTabSendModesHi._(_root);
  @override
  String get sendModeHelp => 'व्याख्या';
  @override
  String get help =>
      'कृपया सुनिश्चित करें कि वांछित लक्ष्य भी उसी वाई-फाई नेटवर्क पर हो।';
  @override
...
class _StringsSettingsTabHi extends _StringsSettingsTabEn {
  _StringsSettingsTabHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSettingsTabGeneralHi general =
      _StringsSettingsTabGeneralHi._(_root);
  @override
  late final _StringsSettingsTabReceiveHi receive =
      _StringsSettingsTabReceiveHi._(_root);
  @override
  late final _StringsSettingsTabSendHi send =
      _StringsSettingsTabSendHi._(_root);
  @override
  late final _StringsSettingsTabNetworkHi network =
      _StringsSettingsTabNetworkHi._(_root);
  @override
  late final _StringsSettingsTabOtherHi other =
      _StringsSettingsTabOtherHi._(_root);
  @override
...
class _StringsTroubleshootPageHi extends _StringsTroubleshootPageEn {
  _StringsTroubleshootPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get subTitle =>
      'क्या ऐप उम्मीद के मुताबिक काम नहीं कर रहा है? यहाँ आप कुछ सामान्य समाधान पा सकते हैं।';
  @override
  String get solution => 'समाधान:';
  @override
  String get fixButton => 'स्वतः ठीक करें';
  @override
  late final _StringsTroubleshootPageFirewallHi firewall =
      _StringsTroubleshootPageFirewallHi._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionHi noConnection =
      _StringsTroubleshootPageNoConnectionHi._(_root);
}

// Path: receiveHistoryPage
class _StringsReceiveHistoryPageHi extends _StringsReceiveHistoryPageEn {
  _StringsReceiveHistoryPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsHi entryActions =
      _StringsReceiveHistoryPageEntryActionsHi._(_root);
}

// Path: apkPickerPage
class _StringsApkPickerPageHi extends _StringsApkPickerPageEn {
  _StringsApkPickerPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String get excludeAppsWithoutLaunchIntent =>
      'लॉन्च न किए जा सकने वाले ऐप्स को बाहर रखें';
  @override
...
class _StringsSelectedFilesPageHi extends _StringsSelectedFilesPageEn {
  _StringsSelectedFilesPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsReceivePageHi extends _StringsReceivePageEn {
  _StringsReceivePageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveOptionsPageHi extends _StringsReceiveOptionsPageEn {
  _StringsReceiveOptionsPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String get saveToGalleryOff =>
      'स्वचालित रूप से बंद कर दिया गया क्योंकि वहाँ निर्देशिकाएँ हैं।';
}

// Path: sendPage
class _StringsSendPageHi extends _StringsSendPageEn {
  _StringsSendPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageHi extends _StringsProgressPageEn {
  _StringsProgressPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsProgressPageTotalHi total =
      _StringsProgressPageTotalHi._(_root);
}

// Path: webSharePage
class _StringsWebSharePageHi extends _StringsWebSharePageEn {
  _StringsWebSharePageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String get encryptionHint =>
      'LocalSend एक स्व-हस्ताक्षरित प्रमाणपत्र का उपयोग करता है। आपको इसे अपने ब्राउज़र में स्वीकार करना होगा।';
  @override
...
class _StringsAboutPageHi extends _StringsAboutPageEn {
  _StringsAboutPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDonationPageHi extends _StringsDonationPageEn {
  _StringsDonationPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get info =>
      'LocalSend मुफ्त, ओपन-सोर्स और बिना किसी विज्ञापन के है। यदि आपको ऐप पसंद है, तो आप विकास का समर्थन दान करके कर सकते हैं।';
  @override
...
class _StringsChangelogPageHi extends _StringsChangelogPageEn {
  _StringsChangelogPageHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsAliasGeneratorHi extends _StringsAliasGeneratorEn {
  _StringsAliasGeneratorHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsHi extends _StringsDialogsEn {
  _StringsDialogsHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  late final _StringsDialogsAddFileHi addFile =
      _StringsDialogsAddFileHi._(_root);
  @override
  late final _StringsDialogsAddressInputHi addressInput =
      _StringsDialogsAddressInputHi._(_root);
  @override
  late final _StringsDialogsCancelSessionHi cancelSession =
      _StringsDialogsCancelSessionHi._(_root);
  @override
  late final _StringsDialogsCannotOpenFileHi cannotOpenFile =
      _StringsDialogsCannotOpenFileHi._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticeHi
      encryptionDisabledNotice =
      _StringsDialogsEncryptionDisabledNoticeHi._(_root);
  @override
  late final _StringsDialogsErrorDialogHi errorDialog =
      _StringsDialogsErrorDialogHi._(_root);
  @override
  late final _StringsDialogsFavoriteDialogHi favoriteDialog =
      _StringsDialogsFavoriteDialogHi._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogHi favoriteDeleteDialog =
      _StringsDialogsFavoriteDeleteDialogHi._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogHi favoriteEditDialog =
      _StringsDialogsFavoriteEditDialogHi._(_root);
  @override
  late final _StringsDialogsFileInfoHi fileInfo =
      _StringsDialogsFileInfoHi._(_root);
  @override
  late final _StringsDialogsFileNameInputHi fileNameInput =
      _StringsDialogsFileNameInputHi._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogHi historyClearDialog =
      _StringsDialogsHistoryClearDialogHi._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedHi
      localNetworkUnauthorized =
      _StringsDialogsLocalNetworkUnauthorizedHi._(_root);
  @override
  late final _StringsDialogsMessageInputHi messageInput =
      _StringsDialogsMessageInputHi._(_root);
  @override
  late final _StringsDialogsNoFilesHi noFiles =
      _StringsDialogsNoFilesHi._(_root);
  @override
  late final _StringsDialogsNoPermissionHi noPermission =
      _StringsDialogsNoPermissionHi._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformHi notAvailableOnPlatform =
      _StringsDialogsNotAvailableOnPlatformHi._(_root);
  @override
  late final _StringsDialogsQrHi qr = _StringsDialogsQrHi._(_root);
  @override
  late final _StringsDialogsQuickActionsHi quickActions =
      _StringsDialogsQuickActionsHi._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticeHi quickSaveNotice =
      _StringsDialogsQuickSaveNoticeHi._(_root);
  @override
  late final _StringsDialogsPinHi pin = _StringsDialogsPinHi._(_root);
  @override
  late final _StringsDialogsSendModeHelpHi sendModeHelp =
      _StringsDialogsSendModeHelpHi._(_root);
  @override
  late final _StringsDialogsZoomHi zoom = _StringsDialogsZoomHi._(_root);
}

// Path: sanitization
class _StringsSanitizationHi extends _StringsSanitizationEn {
  _StringsSanitizationHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsTrayHi extends _StringsTrayEn {
  _StringsTrayHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsWebHi extends _StringsWebEn {
  _StringsWebHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerHi extends _StringsAssetPickerEn {
  _StringsAssetPickerHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String get viewingLimitedAssetsTip =>
      'केवल उन फ़ाइलों और एलबमों को देखें जो ऐप तक पहुंच योग्य हैं।';
  @override
  String get changeAccessibleLimitedAssets =>
      'पहुंच योग्य फ़ाइलों को अपडेट करने के लिए क्लिक करें';
  @override
...
class _StringsReceiveTabInfoBoxHi extends _StringsReceiveTabInfoBoxEn {
  _StringsReceiveTabInfoBoxHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSelectionHi extends _StringsSendTabSelectionEn {
  _StringsSendTabSelectionHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabPickerHi extends _StringsSendTabPickerEn {
  _StringsSendTabPickerHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSendModesHi extends _StringsSendTabSendModesEn {
  _StringsSendTabSendModesHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralHi extends _StringsSettingsTabGeneralEn {
  _StringsSettingsTabGeneralHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsHi brightnessOptions =
      _StringsSettingsTabGeneralBrightnessOptionsHi._(_root);
  @override
  String get color => 'रंग';
  @override
  late final _StringsSettingsTabGeneralColorOptionsHi colorOptions =
      _StringsSettingsTabGeneralColorOptionsHi._(_root);
  @override
  String get language => 'भाषा';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsHi languageOptions =
      _StringsSettingsTabGeneralLanguageOptionsHi._(_root);
  @override
...
class _StringsSettingsTabReceiveHi extends _StringsSettingsTabReceiveEn {
  _StringsSettingsTabReceiveHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabSendHi extends _StringsSettingsTabSendEn {
  _StringsSettingsTabSendHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String get shareViaLinkAutoAccept =>
      'लिंक के माध्यम से साझा करें: स्वतः स्वीकार';
}

// Path: settingsTab.network
class _StringsSettingsTabNetworkHi extends _StringsSettingsTabNetworkEn {
  _StringsSettingsTabNetworkHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String get needRestart =>
      'सेटिंग्स लागू करने के लिए सर्वर को पुनः प्रारंभ करें!';
  @override
...
class _StringsSettingsTabOtherHi extends _StringsSettingsTabOtherEn {
  _StringsSettingsTabOtherHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageFirewallHi
    extends _StringsTroubleshootPageFirewallEn {
  _StringsTroubleshootPageFirewallHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get symptom =>
      'यह ऐप अन्य उपकरणों को फाइल भेज सकता है; लेकिन अन्य उपकरण इस डिवाइस को फाइल नहीं भेज सकते।';
  @override
...
class _StringsTroubleshootPageNoConnectionHi
    extends _StringsTroubleshootPageNoConnectionEn {
  _StringsTroubleshootPageNoConnectionHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get symptom =>
      'दोनों उपकरण एक दूसरे को खोज नहीं सकते और न ही वे फाइल साझा कर सकते हैं।';
  @override
  String get solution =>
...
class _StringsReceiveHistoryPageEntryActionsHi
    extends _StringsReceiveHistoryPageEntryActionsEn {
  _StringsReceiveHistoryPageEntryActionsHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalHi extends _StringsProgressPageTotalEn {
  _StringsProgressPageTotalHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitleHi title =
      _StringsProgressPageTotalTitleHi._(_root);
  @override
...
class _StringsDialogsAddFileHi extends _StringsDialogsAddFileEn {
  _StringsDialogsAddFileHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddressInputHi extends _StringsDialogsAddressInputEn {
  _StringsDialogsAddressInputHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCancelSessionHi extends _StringsDialogsCancelSessionEn {
  _StringsDialogsCancelSessionHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'क्या आप वास्तव में फ़ाइल स्थानांतरण रद्द करना चाहते हैं?';
}

// Path: dialogs.cannotOpenFile
class _StringsDialogsCannotOpenFileHi extends _StringsDialogsCannotOpenFileEn {
  _StringsDialogsCannotOpenFileHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String content({required Object file}) =>
      '"${file}" खोल नहीं सके। क्या यह फ़ाइल स्थानांतरित कर दी गई या नाम बदला या हटा दिया गया है?';
}

// Path: dialogs.encryptionDisabledNotice
class _StringsDialogsEncryptionDisabledNoticeHi
    extends _StringsDialogsEncryptionDisabledNoticeEn {
  _StringsDialogsEncryptionDisabledNoticeHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsErrorDialogHi extends _StringsDialogsErrorDialogEn {
  _StringsDialogsErrorDialogHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDialogHi extends _StringsDialogsFavoriteDialogEn {
  _StringsDialogsFavoriteDialogHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDeleteDialogHi
    extends _StringsDialogsFavoriteDeleteDialogEn {
  _StringsDialogsFavoriteDeleteDialogHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  String content({required Object name}) =>
      'क्या आप वास्तव में "${name}" को पसंदीदा से हटाना चाहते हैं?';
}

// Path: dialogs.favoriteEditDialog
class _StringsDialogsFavoriteEditDialogHi
    extends _StringsDialogsFavoriteEditDialogEn {
  _StringsDialogsFavoriteEditDialogHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileInfoHi extends _StringsDialogsFileInfoEn {
  _StringsDialogsFileInfoHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileNameInputHi extends _StringsDialogsFileNameInputEn {
  _StringsDialogsFileNameInputHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsHistoryClearDialogHi
    extends _StringsDialogsHistoryClearDialogEn {
  _StringsDialogsHistoryClearDialogHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsLocalNetworkUnauthorizedHi
    extends _StringsDialogsLocalNetworkUnauthorizedEn {
  _StringsDialogsLocalNetworkUnauthorizedHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsMessageInputHi extends _StringsDialogsMessageInputEn {
  _StringsDialogsMessageInputHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoFilesHi extends _StringsDialogsNoFilesEn {
  _StringsDialogsNoFilesHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoPermissionHi extends _StringsDialogsNoPermissionEn {
  _StringsDialogsNoPermissionHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'आपने आवश्यक अनुमतियाँ नहीं दी हैं। कृपया सेटिंग्स में उन्हें अनुमति दें।';
}

// Path: dialogs.notAvailableOnPlatform
class _StringsDialogsNotAvailableOnPlatformHi
    extends _StringsDialogsNotAvailableOnPlatformEn {
  _StringsDialogsNotAvailableOnPlatformHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQrHi extends _StringsDialogsQrEn {
  _StringsDialogsQrHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickActionsHi extends _StringsDialogsQuickActionsEn {
  _StringsDialogsQuickActionsHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickSaveNoticeHi
    extends _StringsDialogsQuickSaveNoticeEn {
  _StringsDialogsQuickSaveNoticeHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'फ़ाइल अनुरोध स्वचालित रूप से स्वीकार कर लिए जाते हैं। ध्यान दें कि स्थानीय नेटवर्क पर सभी लोग आपको फ़ाइलें भेज सकते हैं।';
}

// Path: dialogs.pin
class _StringsDialogsPinHi extends _StringsDialogsPinEn {
  _StringsDialogsPinHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpHi extends _StringsDialogsSendModeHelpEn {
  _StringsDialogsSendModeHelpHi._(_StringsHi root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get single =>
      'एक प्राप्तकर्ता को फ़ाइलें भेजता है। फ़ाइल ट्रांसफर समाप्त होने के बाद चयन हटा दिया जाएगा।';
  @override
  String get multiple =>
      'कई प्राप्तकर्ताओं को फ़ाइलें भेजता है। चयन हटाया नहीं जाएगा।';
  @override
  String get link =>
      'जिन प्राप्तकर्ताओं के पास LocalSend इंस्टॉल नहीं है, वे अपने ब्राउज़र में लिंक खोलकर चयनित फ़ाइलें डाउनलोड कर सकते हैं।';
}

// Path: dialogs.zoom
class _StringsDialogsZoomHi extends _StringsDialogsZoomEn {
  _StringsDialogsZoomHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralBrightnessOptionsHi
    extends _StringsSettingsTabGeneralBrightnessOptionsEn {
  _StringsSettingsTabGeneralBrightnessOptionsHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralColorOptionsHi
    extends _StringsSettingsTabGeneralColorOptionsEn {
  _StringsSettingsTabGeneralColorOptionsHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralLanguageOptionsHi
    extends _StringsSettingsTabGeneralLanguageOptionsEn {
  _StringsSettingsTabGeneralLanguageOptionsHi._(_StringsHi root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalTitleHi
    extends _StringsProgressPageTotalTitleEn {
  _StringsProgressPageTotalTitleHi._(_StringsHi root)
      : this._root = root,
        super._(root);
