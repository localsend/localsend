...
class _StringsId extends Translations {
  ...
  @override
  late final _StringsReceiveTabId receiveTab = _StringsReceiveTabId._(_root);
  @override
  late final _StringsSendTabId sendTab = _StringsSendTabId._(_root);
  @override
  ...
  @override
  late final _StringsSanitizationId sanitization =
      _StringsSanitizationId._(_root);
  @override
  late final _StringsTrayId tray = _StringsTrayId._(_root);
  @override
  late final _StringsWebId web = _StringsWebId._(_root);
  @override
  late final _StringsAssetPickerId assetPicker = _StringsAssetPickerId._(_root);
}

// Path: general
class _StringsGeneralId extends _StringsGeneralEn {
  _StringsGeneralId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveTabId extends _StringsReceiveTabEn {
  _StringsReceiveTabId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabId extends _StringsSendTabEn {
  _StringsSendTabId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  String get shareIntentInfo =>
      'Anda juga dapat menggunakan fitur "Berbagi" untuk memilih berkas dengan lebih mudah.';
  @override
...
class _StringsSettingsTabId extends _StringsSettingsTabEn {
  _StringsSettingsTabId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSettingsTabSendId send =
      _StringsSettingsTabSendId._(_root);
  @override
...
class _StringsTroubleshootPageId extends _StringsTroubleshootPageEn {
  _StringsTroubleshootPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveHistoryPageId extends _StringsReceiveHistoryPageEn {
  _StringsReceiveHistoryPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsApkPickerPageId extends _StringsApkPickerPageEn {
  _StringsApkPickerPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSelectedFilesPageId extends _StringsSelectedFilesPageEn {
  _StringsSelectedFilesPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsReceivePageId extends _StringsReceivePageEn {
  _StringsReceivePageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveOptionsPageId extends _StringsReceiveOptionsPageEn {
  _StringsReceiveOptionsPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSendPageId extends _StringsSendPageEn {
  _StringsSendPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageId extends _StringsProgressPageEn {
  _StringsProgressPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsWebSharePageId extends _StringsWebSharePageEn {
  _StringsWebSharePageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsAboutPageId extends _StringsAboutPageEn {
  _StringsAboutPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDonationPageId extends _StringsDonationPageEn {
  _StringsDonationPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsChangelogPageId extends _StringsChangelogPageEn {
  _StringsChangelogPageId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsAliasGeneratorId extends _StringsAliasGeneratorEn {
  _StringsAliasGeneratorId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsId extends _StringsDialogsEn {
  _StringsDialogsId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsDialogsZoomId zoom = _StringsDialogsZoomId._(_root);
}

// Path: sanitization
class _StringsSanitizationId extends _StringsSanitizationEn {
  _StringsSanitizationId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsTrayId extends _StringsTrayEn {
  _StringsTrayId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsWebId extends _StringsWebEn {
  _StringsWebId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerId extends _StringsAssetPickerEn {
  _StringsAssetPickerId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  String get unableToAccessAll =>
      'Tidak dapat mengakses semua berkas di perangkat';
  @override
  String get viewingLimitedAssetsTip =>
      'Hanya melihat berkas dan album yang dapat diakses oleh aplikasi.';
  @override
  String get changeAccessibleLimitedAssets =>
      'Klik untuk memperbarui berkas yang dapat diakses';
  @override
...
class _StringsReceiveTabInfoBoxId extends _StringsReceiveTabInfoBoxEn {
  _StringsReceiveTabInfoBoxId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSelectionId extends _StringsSendTabSelectionEn {
  _StringsSendTabSelectionId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabPickerId extends _StringsSendTabPickerEn {
  _StringsSendTabPickerId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSendModesId extends _StringsSendTabSendModesEn {
  _StringsSendTabSendModesId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralId extends _StringsSettingsTabGeneralEn {
  _StringsSettingsTabGeneralId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabReceiveId extends _StringsSettingsTabReceiveEn {
  _StringsSettingsTabReceiveId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabSendId extends _StringsSettingsTabSendEn {
  _StringsSettingsTabSendId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  String get shareViaLinkAutoAccept =>
      'Bagikan melalui tautan: Terima otomatis';
}

// Path: settingsTab.network
class _StringsSettingsTabNetworkId extends _StringsSettingsTabNetworkEn {
  _StringsSettingsTabNetworkId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabOtherId extends _StringsSettingsTabOtherEn {
  _StringsSettingsTabOtherId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageFirewallId
  ...
  @override
  String get symptom =>
      'Aplikasi ini dapat mengirim berkas ke perangkat lain tetapi perangkat lain tidak dapat mengirim berkas ke perangkat ini.';
  @override
...
class _StringsTroubleshootPageNoConnectionId
  ...
  @override
  String get symptom =>
      'Kedua perangkat tidak dapat saling menemukan atau berbagi berkas.';
  @override
  String get solution =>
      'Pastikan kedua perangkat berada dalam jaringan wifi yang sama dan berbagi konfigurasi yang sama (port, alamat multicast, enkripsi). Jika wifi tidak memperbolehkan komunikasi, aktifkan opsi ini pada router.';
}
...
class _StringsProgressPageTotalId extends _StringsProgressPageTotalEn {
  _StringsProgressPageTotalId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddFileId extends _StringsDialogsAddFileEn {
  _StringsDialogsAddFileId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddressInputId extends _StringsDialogsAddressInputEn {
  _StringsDialogsAddressInputId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCancelSessionId extends _StringsDialogsCancelSessionEn {
  _StringsDialogsCancelSessionId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Apakah Anda yakin untuk membatalkan pengiriman berkas?';
}

// Path: dialogs.cannotOpenFile
class _StringsDialogsCannotOpenFileId extends _StringsDialogsCannotOpenFileEn {
  _StringsDialogsCannotOpenFileId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  String content({required Object file}) =>
      'Tidak dapat membuka "${file}". Apakah berkas ini telah dipindahkan, berganti nama, atau dihapus?';
}
...
class _StringsDialogsErrorDialogId extends _StringsDialogsErrorDialogEn {
  _StringsDialogsErrorDialogId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDialogId extends _StringsDialogsFavoriteDialogEn {
  _StringsDialogsFavoriteDialogId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileInfoId extends _StringsDialogsFileInfoEn {
  _StringsDialogsFileInfoId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileNameInputId extends _StringsDialogsFileNameInputEn {
  _StringsDialogsFileNameInputId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsMessageInputId extends _StringsDialogsMessageInputEn {
  _StringsDialogsMessageInputId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoFilesId extends _StringsDialogsNoFilesEn {
  _StringsDialogsNoFilesId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoPermissionId extends _StringsDialogsNoPermissionEn {
  _StringsDialogsNoPermissionId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQrId extends _StringsDialogsQrEn {
  _StringsDialogsQrId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickActionsId extends _StringsDialogsQuickActionsEn {
  _StringsDialogsQuickActionsId._(_StringsId root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickSaveNoticeId
  ...
  @override
  String get content =>
      'Semua permintaan akan langsung diterima. Harap berhati-hati bahwa semua orang di jaringan lokal dapat mengirim berkas.';
}

// Path: dialogs.sendModeHelp
class _StringsDialogsSendModeHelpId extends _StringsDialogsSendModeHelpEn {
  _StringsDialogsSendModeHelpId._(_StringsId root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get single =>
      'Mengirim berkas ke satu penerima. Pilihan akan dihapus setelah selesai membagikan berkas.';
  @override
  String get multiple =>
      'Mengirim berkas ke beberapa penerima. Pilihan tidak akan dihapus.';
  @override
  String get link =>
      'Penerima yang tidak memiliki LocalSend dapat mengunduh berkas yang dipilih dengan membuka tautan di peramban mereka.';
}

// Path: dialogs.zoom
class _StringsDialogsZoomId extends _StringsDialogsZoomEn {
  _StringsDialogsZoomId._(_StringsId root)
      : this._root = root,
        super._(root);
