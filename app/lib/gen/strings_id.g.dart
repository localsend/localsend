...
class _StringsGeneralId extends _StringsGeneralEn {
  ...
  @override String get continueStr => 'Lanjutkan'; // revision translation from 'Lanjut'
  @override String get copy => 'Salin';
  @override String get copiedToClipboard => 'Disalin ke papan klip'; // revision translation from 'Disalin ke Papan klip'
  ...
  @override String get hide => 'Sembunyikan'; // revision translation from 'sembunyi'
  ...
  @override String get restart => 'Mulai Ulang'; // revision translation from 'Mengulang Kembali'
  ...
  @override String get noItemInClipboard => 'Tidak ada item di papan klip'; // revision translation from 'Papan klip'
}
...
class _StringsSendTabId extends _StringsSendTabEn {
  ...
  @override String get shareIntentInfo => 'Anda juga dapat menggunakan fitur "Bagikan" untuk memilih berkas dengan lebih mudah.'; // revision translation from 'Berbagi'
  @override String get nearbyDevices => 'Perangkat terdekat';
  @override String get thisDevice => 'Perangkat ini';
  @override String get scan => 'Pindai perangkat'; // revision translation from 'Cari perangkat'
  ...
  @override String get placeItems => 'Letakkan item yang ingin dibagikan.'; // revision translation from 'item untuk dibagikan'
}
...
class _StringsTroubleshootPageId extends _StringsTroubleshootPageEn {
  ...
  @override String get subTitle => 'Aplikasi ini tidak berfungsi seperti yang diharapkan? Temukan solusi umum di sini.'; // Revisi agar lebih ringkas
...
class _StringsProgressPageId extends _StringsProgressPageEn {
  ...
  @override String get savedToGallery => 'Disimpan ke galeri'; // revision translation from 'Simpan ke galeri'
...
class _StringsAboutPageId extends _StringsAboutPageEn {
  ...
  @override List<String> get description => [
    ...
    'Aplikasi ini tersedia untuk Android, iOS, macOS, Windows, dan Linux. Anda dapat menemukan semua pilihan unduhan pada halaman resmi kami.', // Menambahkan koma Oxford untuk konsistensi
  ];
  @override String get author => 'Pencipta';
  @override String get contributors => 'Daftar Kontributor';
  @override String get translators => 'Daftar Penerjemah'; // revision translation from 'Daftar Terjemahan'
}
...
class _StringsDonationPageId extends _StringsDonationPageEn {
  ...
  @override String get info => 'LocalSend merupakan aplikasi gratis, open-source, dan bebas iklan. Jika Anda menyukai aplikasi ini, Anda dapat membantu dengan cara memberikan donasi.'; // Penyesuaian agar lebih konsisten
  @override String donate({required Object amount}) => 'Donasi ${amount}';
  @override String get thanks => 'Terima kasih banyak!';
  @override String get restore => 'Pulihkan pembelian'; // revision translation from 'Kembalikan dana'
}
...
class _StringsAliasGeneratorId extends _StringsAliasGeneratorEn {
  ...
  @override List<String> get adjectives => [
    ...
    'Tampan',
    'Panas',
    'Menyenangkan', // deleted duplication 'Baik'
    'Mistik',
    'Rapi',
    'Sabar',
    'Kuat',
  ...
  @override List<String> get fruits => [
    'Apel',
    'Alpukat',
    'Pisang', // revision translation from 'Pisan'
    'Blackberry',
    'Blueberry',
    'Brokoli',
    'Wortel',
    ...
    'Kentang',
    'Labu',
    'Raspberry', // revision translation from 'Rasberi'
    'Stroberi',
    'Tomat',
  ];
...
class _StringsSettingsTabGeneralId extends _StringsSettingsTabGeneralEn {
  ...
  @override String get launchMinimized => 'Mulai otomatis: Berjalan di latar belakang'; // revision translation from 'berjalan di belakang'
...
class _StringsSettingsTabSendId extends _StringsSettingsTabSendEn {
  ...
  // Translations
  @override String get title => 'Kirim';
  @override String get shareViaLinkAutoAccept => 'Bagikan via tautan: Terima otomatis';
}
...
class _StringsSettingsTabNetworkId extends _StringsSettingsTabNetworkEn {
  ...
  @override String portWarning({required Object defaultPort}) => 'Anda mungkin tidak terdeteksi oleh perangkat lain karena Anda menggunakan port kustom. (bawaan: ${defaultPort})'; // revision translation from 'dikarenakan'
  @override String get encryption => 'Enkripsi';
  @override String get multicastGroup => 'Multicast';
  @override String multicastGroupWarning({required Object defaultMulticast}) => 'Anda mungkin tidak terdeteksi oleh perangkat lain karena Anda menggunakan alamat multicast kustom. (bawaan: ${defaultMulticast})';
}
...
class _StringsDialogsAddressInputId extends _StringsDialogsAddressInputEn {
  ...
  // Translations
  @override String get title => 'Masukkan Alamat'; // revision translation from 'Masukan'
...
class _StringsDialogsCancelSessionId extends _StringsDialogsCancelSessionEn {
  ...
  @override String get content => 'Apakah Anda yakin ingin membatalkan pengiriman berkas?'; // Revisi kalimat agar lebih formal
}
...
class _StringsDialogsFavoriteDialogId extends _StringsDialogsFavoriteDialogEn {
  ...
  @override String get noFavorites => 'Tidak ada perangkat yang difavoritkan.'; // Revisi agar lebih natural
...
class _StringsDialogsFavoriteDeleteDialogId extends _StringsDialogsFavoriteDeleteDialogEn {
  ...
  @override String content({required Object name}) => 'Anda yakin ingin menghapus "${name}" dari daftar favorit?'; // Revisi susunan kalimat
}
...
class _StringsDialogsFileNameInputId extends _StringsDialogsFileNameInputEn {
  ...
  // Translations
  @override String get title => 'Masukkan nama berkas'; // revision translation from 'Masukan'
...
class _StringsDialogsMessageInputId extends _StringsDialogsMessageInputEn {
  ...
  @override String get multiline => 'Banyak baris'; // revision translation from 'Baris ganda'
}
