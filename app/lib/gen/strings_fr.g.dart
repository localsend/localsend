...
class _StringsFr extends Translations {
  ...
  @override
  late final _StringsGeneralFr general = _StringsGeneralFr._(_root);
  @override
  late final _StringsReceiveTabFr receiveTab = _StringsReceiveTabFr._(_root);
  @override
  late final _StringsSendTabFr sendTab = _StringsSendTabFr._(_root);
  @override
  late final _StringsSettingsTabFr settingsTab = _StringsSettingsTabFr._(_root);
  @override
  late final _StringsTroubleshootPageFr troubleshootPage =
      _StringsTroubleshootPageFr._(_root);
  @override
  late final _StringsReceiveHistoryPageFr receiveHistoryPage =
      _StringsReceiveHistoryPageFr._(_root);
  @override
  late final _StringsApkPickerPageFr apkPickerPage =
      _StringsApkPickerPageFr._(_root);
  @override
  late final _StringsSelectedFilesPageFr selectedFilesPage =
      _StringsSelectedFilesPageFr._(_root);
  @override
  late final _StringsReceivePageFr receivePage = _StringsReceivePageFr._(_root);
  @override
  late final _StringsReceiveOptionsPageFr receiveOptionsPage =
      _StringsReceiveOptionsPageFr._(_root);
  @override
  late final _StringsSendPageFr sendPage = _StringsSendPageFr._(_root);
  @override
  late final _StringsProgressPageFr progressPage =
      _StringsProgressPageFr._(_root);
  @override
  late final _StringsWebSharePageFr webSharePage =
      _StringsWebSharePageFr._(_root);
  @override
  late final _StringsAboutPageFr aboutPage = _StringsAboutPageFr._(_root);
  @override
  late final _StringsDonationPageFr donationPage =
      _StringsDonationPageFr._(_root);
  @override
  late final _StringsChangelogPageFr changelogPage =
      _StringsChangelogPageFr._(_root);
  @override
  late final _StringsAliasGeneratorFr aliasGenerator =
      _StringsAliasGeneratorFr._(_root);
  @override
  late final _StringsDialogsFr dialogs = _StringsDialogsFr._(_root);
  @override
  late final _StringsSanitizationFr sanitization =
      _StringsSanitizationFr._(_root);
  @override
  late final _StringsTrayFr tray = _StringsTrayFr._(_root);
  @override
  late final _StringsWebFr web = _StringsWebFr._(_root);
  @override
  late final _StringsAssetPickerFr assetPicker = _StringsAssetPickerFr._(_root);
}

// Path: general
class _StringsGeneralFr extends _StringsGeneralEn {
  _StringsGeneralFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveTabFr extends _StringsReceiveTabEn {
  _StringsReceiveTabFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsReceiveTabInfoBoxFr infoBox =
      _StringsReceiveTabInfoBoxFr._(_root);
}

// Path: sendTab
class _StringsSendTabFr extends _StringsSendTabEn {
  _StringsSendTabFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSendTabSelectionFr selection =
      _StringsSendTabSelectionFr._(_root);
  @override
  late final _StringsSendTabPickerFr picker = _StringsSendTabPickerFr._(_root);
  @override
  ...
  @override
  String get scan => 'Recherchez des appareils';
  @override
  String get manualSending => 'Envoi manuel';
  @override
  String get sendMode => 'Mode envoi';
  @override
  late final _StringsSendTabSendModesFr sendModes =
      _StringsSendTabSendModesFr._(_root);
  @override
  String get sendModeHelp => 'Explication';
  @override
  String get help =>
      'Veuillez vous assurer que la cible souhaitée se trouve également dans le même réseau wifi.';
  @override
...
class _StringsSettingsTabFr extends _StringsSettingsTabEn {
  _StringsSettingsTabFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSettingsTabGeneralFr general =
      _StringsSettingsTabGeneralFr._(_root);
  @override
  late final _StringsSettingsTabReceiveFr receive =
      _StringsSettingsTabReceiveFr._(_root);
  @override
  late final _StringsSettingsTabSendFr send =
      _StringsSettingsTabSendFr._(_root);
  @override
  late final _StringsSettingsTabNetworkFr network =
      _StringsSettingsTabNetworkFr._(_root);
  @override
  late final _StringsSettingsTabOtherFr other =
      _StringsSettingsTabOtherFr._(_root);
  @override
...
class _StringsTroubleshootPageFr extends _StringsTroubleshootPageEn {
  _StringsTroubleshootPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get subTitle =>
      'Cette application ne marche pas comme vous l\'espérez? Vous pouvez ici trouver des solutions à des problèmes communs.';
  @override
  String get solution => 'Solution:';
  @override
  String get fixButton => 'Régler automatiquement';
  @override
  late final _StringsTroubleshootPageFirewallFr firewall =
      _StringsTroubleshootPageFirewallFr._(_root);
  @override
  late final _StringsTroubleshootPageNoDiscoveryFr noDiscovery =
      _StringsTroubleshootPageNoDiscoveryFr._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionFr noConnection =
      _StringsTroubleshootPageNoConnectionFr._(_root);
}

// Path: receiveHistoryPage
class _StringsReceiveHistoryPageFr extends _StringsReceiveHistoryPageEn {
  _StringsReceiveHistoryPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsFr entryActions =
      _StringsReceiveHistoryPageEntryActionsFr._(_root);
}

// Path: apkPickerPage
class _StringsApkPickerPageFr extends _StringsApkPickerPageEn {
  _StringsApkPickerPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  String get excludeAppsWithoutLaunchIntent =>
      'Exclure les applications non-lançables';
  @override
...
class _StringsSelectedFilesPageFr extends _StringsSelectedFilesPageEn {
  _StringsSelectedFilesPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsReceivePageFr extends _StringsReceivePageEn {
  _StringsReceivePageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveOptionsPageFr extends _StringsReceiveOptionsPageEn {
  _StringsReceiveOptionsPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  String get saveToGalleryOff =>
      'Désactivé automatiquement car des dossiers sont présents.';
}

// Path: sendPage
class _StringsSendPageFr extends _StringsSendPageEn {
  _StringsSendPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get busy => 'Le destinataire est occupé avec une autre requête.';
}

// Path: progressPage
class _StringsProgressPageFr extends _StringsProgressPageEn {
  _StringsProgressPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get savedToGallery => 'Sauvegardé dans Photos';
  @override
  late final _StringsProgressPageTotalFr total =
      _StringsProgressPageTotalFr._(_root);
}

// Path: webSharePage
class _StringsWebSharePageFr extends _StringsWebSharePageEn {
  _StringsWebSharePageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get stopping => 'Fermeture du serveur...';
  @override
  ...
  @override
  String get requirePin => 'Code PIN nécessaire';
  @override
  String pinHint({required Object pin}) => 'Le code PIN est "${pin}"';
  @override
  String get encryptionHint =>
      'LocalSend utilise un certificat auto-signé. Vous devez l\'accepter dans le navigateur.';
  @override
...
class _StringsAboutPageFr extends _StringsAboutPageEn {
  _StringsAboutPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get packagers => 'Empaqueteurs';
  @override
...
class _StringsDonationPageFr extends _StringsDonationPageEn {
  _StringsDonationPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsChangelogPageFr extends _StringsChangelogPageEn {
  _StringsChangelogPageFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsAliasGeneratorFr extends _StringsAliasGeneratorEn {
  _StringsAliasGeneratorFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFr extends _StringsDialogsEn {
  _StringsDialogsFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  late final _StringsDialogsAddFileFr addFile =
      _StringsDialogsAddFileFr._(_root);
  @override
  late final _StringsDialogsAddressInputFr addressInput =
      _StringsDialogsAddressInputFr._(_root);
  @override
  late final _StringsDialogsCancelSessionFr cancelSession =
      _StringsDialogsCancelSessionFr._(_root);
  @override
  late final _StringsDialogsCannotOpenFileFr cannotOpenFile =
      _StringsDialogsCannotOpenFileFr._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticeFr
      encryptionDisabledNotice =
      _StringsDialogsEncryptionDisabledNoticeFr._(_root);
  @override
  late final _StringsDialogsErrorDialogFr errorDialog =
      _StringsDialogsErrorDialogFr._(_root);
  @override
  late final _StringsDialogsFavoriteDialogFr favoriteDialog =
      _StringsDialogsFavoriteDialogFr._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogFr favoriteDeleteDialog =
      _StringsDialogsFavoriteDeleteDialogFr._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogFr favoriteEditDialog =
      _StringsDialogsFavoriteEditDialogFr._(_root);
  @override
  late final _StringsDialogsFileInfoFr fileInfo =
      _StringsDialogsFileInfoFr._(_root);
  @override
  late final _StringsDialogsFileNameInputFr fileNameInput =
      _StringsDialogsFileNameInputFr._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogFr historyClearDialog =
      _StringsDialogsHistoryClearDialogFr._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedFr
      localNetworkUnauthorized =
      _StringsDialogsLocalNetworkUnauthorizedFr._(_root);
  @override
  late final _StringsDialogsMessageInputFr messageInput =
      _StringsDialogsMessageInputFr._(_root);
  @override
  late final _StringsDialogsNoFilesFr noFiles =
      _StringsDialogsNoFilesFr._(_root);
  @override
  late final _StringsDialogsNoPermissionFr noPermission =
      _StringsDialogsNoPermissionFr._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformFr notAvailableOnPlatform =
      _StringsDialogsNotAvailableOnPlatformFr._(_root);
  @override
  late final _StringsDialogsQrFr qr = _StringsDialogsQrFr._(_root);
  @override
  late final _StringsDialogsQuickActionsFr quickActions =
      _StringsDialogsQuickActionsFr._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticeFr quickSaveNotice =
      _StringsDialogsQuickSaveNoticeFr._(_root);
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticeFr
      quickSaveFromFavoritesNotice =
      _StringsDialogsQuickSaveFromFavoritesNoticeFr._(_root);
  @override
  late final _StringsDialogsPinFr pin = _StringsDialogsPinFr._(_root);
  @override
  late final _StringsDialogsSendModeHelpFr sendModeHelp =
      _StringsDialogsSendModeHelpFr._(_root);
  @override
  late final _StringsDialogsZoomFr zoom = _StringsDialogsZoomFr._(_root);
}

// Path: sanitization
class _StringsSanitizationFr extends _StringsSanitizationEn {
  _StringsSanitizationFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsTrayFr extends _StringsTrayEn {
  _StringsTrayFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsWebFr extends _StringsWebEn {
  _StringsWebFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerFr extends _StringsAssetPickerEn {
  _StringsAssetPickerFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  String get accessAllTip =>
      'L\'application ne peut accéder qu\'à certains medias. Allez dans les paramètres système et autoriser l\'application à accéder à tous les medias sur l\'appareil.';
  @override
...
class _StringsReceiveTabInfoBoxFr extends _StringsReceiveTabInfoBoxEn {
  _StringsReceiveTabInfoBoxFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSelectionFr extends _StringsSendTabSelectionEn {
  _StringsSendTabSelectionFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabPickerFr extends _StringsSendTabPickerEn {
  _StringsSendTabPickerFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSendModesFr extends _StringsSendTabSendModesEn {
  _StringsSendTabSendModesFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralFr extends _StringsSettingsTabGeneralEn {
  _StringsSettingsTabGeneralFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsFr brightnessOptions =
      _StringsSettingsTabGeneralBrightnessOptionsFr._(_root);
  @override
  String get color => 'Couleur';
  @override
  late final _StringsSettingsTabGeneralColorOptionsFr colorOptions =
      _StringsSettingsTabGeneralColorOptionsFr._(_root);
  @override
  String get language => 'Langue';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsFr languageOptions =
      _StringsSettingsTabGeneralLanguageOptionsFr._(_root);
  @override
  String get saveWindowPlacement =>
      'Quitter: Sauvegarder l\'emplacement de la fenêtre';
  @override
  String get saveWindowPlacementWindows =>
      'Sauvegarder la position de la fenêtre avant de quitter';
  @override
  String get minimizeToTray => 'Quitter : Réduire à la barre des tâches';
  @override
  String get launchAtStartup => 'Démarrage automatique : Après la connexion';
  @override
...
class _StringsSettingsTabReceiveFr extends _StringsSettingsTabReceiveEn {
  _StringsSettingsTabReceiveFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get autoFinish => 'Finir automatiquement';
  @override
...
class _StringsSettingsTabSendFr extends _StringsSettingsTabSendEn {
  _StringsSettingsTabSendFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  String get shareViaLinkAutoAccept =>
      'Envoyer via un lien: Accepter automatiquement';
}

// Path: settingsTab.network
class _StringsSettingsTabNetworkFr extends _StringsSettingsTabNetworkEn {
  _StringsSettingsTabNetworkFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  String get needRestart =>
      'Redémarrez le serveur pour appliquer les paramètres !';
  @override
  ...
  String get port => 'Port';
  @override
  String get discoveryTimeout => 'Temps maximal de recherche';
  @override
...
class _StringsSettingsTabOtherFr extends _StringsSettingsTabOtherEn {
  _StringsSettingsTabOtherFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageFirewallFr
    extends _StringsTroubleshootPageFirewallEn {
  _StringsTroubleshootPageFirewallFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get symptom =>
      'Cet appareil peut envoyer des fichiers à d\'autres appareils, mais d\'autres appareils ne peuvent pas en envoyer à cet appareil.';
  @override
  String solution({required Object port}) =>
      'Le problème est probablement dû à votre pare-feu. Vous pouvez le régler en autorisant les connections entrantes (UDP et TCP) sur le port ${port}.';
  @override
  String get openFirewall => 'Ouvrir le pare-feu';
}

// Path: troubleshootPage.noDiscovery
class _StringsTroubleshootPageNoDiscoveryFr
    extends _StringsTroubleshootPageNoDiscoveryEn {
  _StringsTroubleshootPageNoDiscoveryFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNoConnectionFr
  ...
  @override
  String get symptom =>
      'Les deux appareils ne peuvent ni se trouver, ni partager des fichiers.';
  @override
  String get solution =>
...
class _StringsReceiveHistoryPageEntryActionsFr
    extends _StringsReceiveHistoryPageEntryActionsEn {
  _StringsReceiveHistoryPageEntryActionsFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalFr extends _StringsProgressPageTotalEn {
  _StringsProgressPageTotalFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitleFr title =
      _StringsProgressPageTotalTitleFr._(_root);
  @override
...
class _StringsDialogsAddFileFr extends _StringsDialogsAddFileEn {
  _StringsDialogsAddFileFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddressInputFr extends _StringsDialogsAddressInputEn {
  _StringsDialogsAddressInputFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'Entrez l\'adresse';
  @override
...
class _StringsDialogsCancelSessionFr extends _StringsDialogsCancelSessionEn {
  _StringsDialogsCancelSessionFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Voulez-vous vraiment annuler le transfert de fichiers ?';
}

// Path: dialogs.cannotOpenFile
class _StringsDialogsCannotOpenFileFr extends _StringsDialogsCannotOpenFileEn {
  _StringsDialogsCannotOpenFileFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  String content({required Object file}) =>
      'Ne peut pas ouvrir "${file}". Ce fichier a-t-il été déplacé, renommé ou supprimé ?';
}

// Path: dialogs.encryptionDisabledNotice
class _StringsDialogsEncryptionDisabledNoticeFr
    extends _StringsDialogsEncryptionDisabledNoticeEn {
  _StringsDialogsEncryptionDisabledNoticeFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'La communication s\'effectue désormais via le protocole HTTP non crypté. Pour utiliser HTTPS, réactivez le chiffrement.';
}

// Path: dialogs.errorDialog
class _StringsDialogsErrorDialogFr extends _StringsDialogsErrorDialogEn {
  _StringsDialogsErrorDialogFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDialogFr extends _StringsDialogsFavoriteDialogEn {
  _StringsDialogsFavoriteDialogFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDeleteDialogFr
    extends _StringsDialogsFavoriteDeleteDialogEn {
  _StringsDialogsFavoriteDeleteDialogFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  String content({required Object name}) =>
      'Voulez-vous vraiment supprimer "${name}" des favoris ?';
}

// Path: dialogs.favoriteEditDialog
class _StringsDialogsFavoriteEditDialogFr
    extends _StringsDialogsFavoriteEditDialogEn {
  _StringsDialogsFavoriteEditDialogFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileInfoFr extends _StringsDialogsFileInfoEn {
  _StringsDialogsFileInfoFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileNameInputFr extends _StringsDialogsFileNameInputEn {
  _StringsDialogsFileNameInputFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsHistoryClearDialogFr
    extends _StringsDialogsHistoryClearDialogEn {
  _StringsDialogsHistoryClearDialogFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content => 'Voulez-vous vraiment effacer l\'historique entier?';
}

// Path: dialogs.localNetworkUnauthorized
class _StringsDialogsLocalNetworkUnauthorizedFr
    extends _StringsDialogsLocalNetworkUnauthorizedEn {
  _StringsDialogsLocalNetworkUnauthorizedFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsMessageInputFr extends _StringsDialogsMessageInputEn {
  _StringsDialogsMessageInputFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoFilesFr extends _StringsDialogsNoFilesEn {
  _StringsDialogsNoFilesFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoPermissionFr extends _StringsDialogsNoPermissionEn {
  _StringsDialogsNoPermissionFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'Pas la permission';
  @override
  String get content =>
      'Vous n\'avez pas accordé les autorisations nécessaires. Veuillez les accorder dans les paramètres.';
}

// Path: dialogs.notAvailableOnPlatform
class _StringsDialogsNotAvailableOnPlatformFr
    extends _StringsDialogsNotAvailableOnPlatformEn {
  _StringsDialogsNotAvailableOnPlatformFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQrFr extends _StringsDialogsQrEn {
  _StringsDialogsQrFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickActionsFr extends _StringsDialogsQuickActionsEn {
  _StringsDialogsQuickActionsFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickSaveNoticeFr
    extends _StringsDialogsQuickSaveNoticeEn {
  _StringsDialogsQuickSaveNoticeFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Les demandes de fichiers sont automatiquement acceptées. Sachez que tous les membres du réseau local peuvent vous envoyer des fichiers.';
}

// Path: dialogs.quickSaveFromFavoritesNotice
class _StringsDialogsQuickSaveFromFavoritesNoticeFr
    extends _StringsDialogsQuickSaveFromFavoritesNoticeEn {
  _StringsDialogsQuickSaveFromFavoritesNoticeFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsPinFr extends _StringsDialogsPinEn {
  _StringsDialogsPinFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpFr extends _StringsDialogsSendModeHelpEn {
  _StringsDialogsSendModeHelpFr._(_StringsFr root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get single =>
      'Envoyer des fichiers à un récipient. La sélection sera effacée une fois l\'envoi du fichier terminé.';
  @override
  String get multiple =>
      'Envoyer des fichiers à plusieurs récipients. La sélection ne sera pas effacée.';
  @override
  String get link =>
...
class _StringsDialogsZoomFr extends _StringsDialogsZoomEn {
  _StringsDialogsZoomFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralBrightnessOptionsFr
    extends _StringsSettingsTabGeneralBrightnessOptionsEn {
  _StringsSettingsTabGeneralBrightnessOptionsFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralColorOptionsFr
    extends _StringsSettingsTabGeneralColorOptionsEn {
  _StringsSettingsTabGeneralColorOptionsFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralLanguageOptionsFr
    extends _StringsSettingsTabGeneralLanguageOptionsEn {
  _StringsSettingsTabGeneralLanguageOptionsFr._(_StringsFr root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalTitleFr
    extends _StringsProgressPageTotalTitleEn {
  _StringsProgressPageTotalTitleFr._(_StringsFr root)
      : this._root = root,
        super._(root);
