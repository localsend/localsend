...
class _StringsSk extends Translations {
  ...
  @override
  late final _StringsTroubleshootPageSk troubleshootPage = _StringsTroubleshootPageSk._(_root);
  @override
  late final _StringsReceiveHistoryPageSk receiveHistoryPage = _StringsReceiveHistoryPageSk._(_root);
  @override
  late final _StringsApkPickerPageSk apkPickerPage = _StringsApkPickerPageSk._(_root);
  @override
  late final _StringsSelectedFilesPageSk selectedFilesPage = _StringsSelectedFilesPageSk._(_root);
  @override
  late final _StringsReceivePageSk receivePage = _StringsReceivePageSk._(_root);
  @override
  late final _StringsReceiveOptionsPageSk receiveOptionsPage = _StringsReceiveOptionsPageSk._(_root);
  @override
  late final _StringsSendPageSk sendPage = _StringsSendPageSk._(_root);
  @override
  late final _StringsProgressPageSk progressPage = _StringsProgressPageSk._(_root);
  @override
  late final _StringsWebSharePageSk webSharePage = _StringsWebSharePageSk._(_root);
  @override
  late final _StringsAboutPageSk aboutPage = _StringsAboutPageSk._(_root);
  @override
  late final _StringsDonationPageSk donationPage = _StringsDonationPageSk._(_root);
  @override
  late final _StringsChangelogPageSk changelogPage = _StringsChangelogPageSk._(_root);
  @override
  late final _StringsAliasGeneratorSk aliasGenerator = _StringsAliasGeneratorSk._(_root);
  @override
  late final _StringsDialogsSk dialogs = _StringsDialogsSk._(_root);
  @override
  late final _StringsSanitizationSk sanitization = _StringsSanitizationSk._(_root);
  @override
...
class _StringsReceiveTabSk extends _StringsReceiveTabEn {
  ...
  @override
  late final _StringsReceiveTabInfoBoxSk infoBox = _StringsReceiveTabInfoBoxSk._(_root);
}
...
class _StringsSendTabSk extends _StringsSendTabEn {
  ...
  @override
  late final _StringsSendTabSelectionSk selection = _StringsSendTabSelectionSk._(_root);
  @override
  ...
  @override
  late final _StringsSendTabSendModesSk sendModes = _StringsSendTabSendModesSk._(_root);
  @override
...
class _StringsSettingsTabSk extends _StringsSettingsTabEn {
  ...
  @override
  late final _StringsSettingsTabGeneralSk general = _StringsSettingsTabGeneralSk._(_root);
  @override
  late final _StringsSettingsTabReceiveSk receive = _StringsSettingsTabReceiveSk._(_root);
  @override
  late final _StringsSettingsTabSendSk send = _StringsSettingsTabSendSk._(_root);
  @override
  late final _StringsSettingsTabNetworkSk network = _StringsSettingsTabNetworkSk._(_root);
  @override
  late final _StringsSettingsTabOtherSk other = _StringsSettingsTabOtherSk._(_root);
  @override
...
class _StringsTroubleshootPageSk extends _StringsTroubleshootPageEn {
  ...
  @override
  late final _StringsTroubleshootPageFirewallSk firewall = _StringsTroubleshootPageFirewallSk._(_root);
  @override
  late final _StringsTroubleshootPageNoDiscoverySk noDiscovery = _StringsTroubleshootPageNoDiscoverySk._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionSk noConnection = _StringsTroubleshootPageNoConnectionSk._(_root);
}
...
class _StringsReceiveHistoryPageSk extends _StringsReceiveHistoryPageEn {
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsSk entryActions = _StringsReceiveHistoryPageEntryActionsSk._(_root);
}
...
class _StringsProgressPageSk extends _StringsProgressPageEn {
  ...
  @override
  late final _StringsProgressPageTotalSk total = _StringsProgressPageTotalSk._(_root);
}
...
class _StringsDialogsSk extends _StringsDialogsEn {
  ...
  // Translations
  @override
  late final _StringsDialogsAddFileSk addFile = _StringsDialogsAddFileSk._(_root);
  @override
  late final _StringsDialogsAddressInputSk addressInput = _StringsDialogsAddressInputSk._(_root);
  @override
  late final _StringsDialogsCancelSessionSk cancelSession = _StringsDialogsCancelSessionSk._(_root);
  @override
  late final _StringsDialogsCannotOpenFileSk cannotOpenFile = _StringsDialogsCannotOpenFileSk._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticeSk encryptionDisabledNotice = _StringsDialogsEncryptionDisabledNoticeSk._(_root);
  @override
  late final _StringsDialogsErrorDialogSk errorDialog = _StringsDialogsErrorDialogSk._(_root);
  @override
  late final _StringsDialogsFavoriteDialogSk favoriteDialog = _StringsDialogsFavoriteDialogSk._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogSk favoriteDeleteDialog = _StringsDialogsFavoriteDeleteDialogSk._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogSk favoriteEditDialog = _StringsDialogsFavoriteEditDialogSk._(_root);
  @override
  late final _StringsDialogsFileInfoSk fileInfo = _StringsDialogsFileInfoSk._(_root);
  @override
  late final _StringsDialogsFileNameInputSk fileNameInput = _StringsDialogsFileNameInputSk._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogSk historyClearDialog = _StringsDialogsHistoryClearDialogSk._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedSk localNetworkUnauthorized = _StringsDialogsLocalNetworkUnauthorizedSk._(_root);
  @override
  late final _StringsDialogsMessageInputSk messageInput = _StringsDialogsMessageInputSk._(_root);
  @override
  late final _StringsDialogsNoFilesSk noFiles = _StringsDialogsNoFilesSk._(_root);
  @override
  late final _StringsDialogsNoPermissionSk noPermission = _StringsDialogsNoPermissionSk._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformSk notAvailableOnPlatform = _StringsDialogsNotAvailableOnPlatformSk._(_root);
  @override
  late final _StringsDialogsQrSk qr = _StringsDialogsQrSk._(_root);
  @override
  late final _StringsDialogsQuickActionsSk quickActions = _StringsDialogsQuickActionsSk._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticeSk quickSaveNotice = _StringsDialogsQuickSaveNoticeSk._(_root);
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticeSk quickSaveFromFavoritesNotice = _StringsDialogsQuickSaveFromFavoritesNoticeSk._(_root);
  @override
  late final _StringsDialogsPinSk pin = _StringsDialogsPinSk._(_root);
  @override
  late final _StringsDialogsSendModeHelpSk sendModeHelp = _StringsDialogsSendModeHelpSk._(_root);
  @override
...
class _StringsSettingsTabGeneralSk extends _StringsSettingsTabGeneralEn {
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsSk brightnessOptions = _StringsSettingsTabGeneralBrightnessOptionsSk._(_root);
  @override
  String get color => 'Farba';
  @override
  late final _StringsSettingsTabGeneralColorOptionsSk colorOptions = _StringsSettingsTabGeneralColorOptionsSk._(_root);
  @override
  String get language => 'Jazyk';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsSk languageOptions = _StringsSettingsTabGeneralLanguageOptionsSk._(_root);
  @override
...
class _StringsProgressPageTotalSk extends _StringsProgressPageTotalEn {
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitleSk title = _StringsProgressPageTotalTitleSk._(_root);
  @override
