...
class _StringsTh extends Translations {
  ...
  @override
  late final _StringsSanitizationTh sanitization =
      _StringsSanitizationTh._(_root);
  @override
...
class _StringsSendTabTh extends _StringsSendTabEn {
  ...
  String get shareIntentInfo =>
      'คุณยังสามารถใช้ฟีเจอร์ "แชร์" บนอุปกรณ์ของคุณเพื่อเลือกไฟล์ที่ต้องการได้อย่างง่ายดาย';
  @override
  ...
  @override
  String get help =>
      'โปรดตรวจสอบให้แน่ใจว่าอุปกรณ์เป้าหมายเชื่อมต่ออยู่ภายในเครือข่าย WiFi เดียวกันแล้ว';
  @override
...
class _StringsSettingsTabTh extends _StringsSettingsTabEn {
  ...
  @override
  late final _StringsSettingsTabSendTh send =
      _StringsSettingsTabSendTh._(_root);
  @override
...
class _StringsTroubleshootPageTh extends _StringsTroubleshootPageEn {
  ...
  @override
  String get subTitle =>
      'มีปัญหาเกี่ยวกับการใช้งานแอปอยู่หรือเปล่า? คุณสามารถค้นหาวิธีการแก้ปัญหาเบื้องต้นได้จากที่นี้';
  @override
  ...
  @override
  late final _StringsTroubleshootPageNoDiscoveryTh noDiscovery =
      _StringsTroubleshootPageNoDiscoveryTh._(_root);
  @override
...
class _StringsApkPickerPageTh extends _StringsApkPickerPageEn {
  ...
  String get excludeAppsWithoutLaunchIntent =>
      'ไม่แสดงแอปที่ไม่สามารถเปิดใช้งานได้';
  @override
...
class _StringsDialogsTh extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsPinTh pin = _StringsDialogsPinTh._(_root);
  @override
  late final _StringsDialogsSendModeHelpTh sendModeHelp =
      _StringsDialogsSendModeHelpTh._(_root);
  @override
  late final _StringsDialogsZoomTh zoom = _StringsDialogsZoomTh._(_root);
}

// Path: sanitization
class _StringsSanitizationTh extends _StringsSanitizationEn {
  _StringsSanitizationTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerTh extends _StringsAssetPickerEn {
  ...
  String get viewingLimitedAssetsTip =>
      'เลือกดูเฉพาะไฟล์และอัลบั้มที่แอปสามารถเข้าถึงได้';
  @override
  String get changeAccessibleLimitedAssets =>
      'คลิกเพื่ออัปเดตไฟล์ที่แอปจะเข้าถึงได้';
  @override
...
class _StringsSettingsTabSendTh extends _StringsSettingsTabSendEn {
  _StringsSettingsTabSendTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  String get shareViaLinkAutoAccept =>
      'ตอบรับคำขอในการโอนถ่ายข้อมูลจากโหมด "แชร์ผ่านลิงก์" โดยอัตโนมัติ';
}
...
class _StringsSettingsTabNetworkTh extends _StringsSettingsTabNetworkEn {
  ...
  String get needRestart =>
      'เริ่มต้นเซิร์ฟเวอร์ใหม่อีกครั้งเพื่อปรับเปลี่ยนค่าให้เป็นไปตามที่ตั้งไว้ก่อนหน้า!';
  @override
...
class _StringsTroubleshootPageFirewallTh
  ...
  @override
  String get symptom =>
      'แอปนี้สามารถส่งไฟล์ข้อมูลไปยังอุปกรณ์อื่นได้ แต่อุปกรณ์อื่นไม่สามารถส่งไฟล์ข้อมูลมายังอุปกรณ์นี้ได้';
  @override
...
class _StringsTroubleshootPageNoDiscoveryTh
    extends _StringsTroubleshootPageNoDiscoveryEn {
  _StringsTroubleshootPageNoDiscoveryTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNoConnectionTh
  ...
  @override
  String get symptom =>
      'อุปกรณ์สำหรับรับ-ส่งข้อมูลค้นหากันไม่เจอและไม่สามารถแชร์ไฟล์ได้';
  @override
  String get solution =>
...
class _StringsDialogsCannotOpenFileTh extends _StringsDialogsCannotOpenFileEn {
  ...
  String content({required Object file}) =>
      'ไม่สามารถเปิดไฟล์ "${file}" ได้ โปรดตรวจสอบว่าไฟล์นี้ได้ถูกย้าย เปลี่ยนชื่อ หรือถูกลบไปแล้วหรือไม่';
}
...
class _StringsDialogsFavoriteDeleteDialogTh
  ...
  String content({required Object name}) =>
      'คุณต้องการลบอุปกรณ์ "${name}" ออกจากรายการโปรดหรือไม่?';
}
...
class _StringsDialogsPinTh extends _StringsDialogsPinEn {
  _StringsDialogsPinTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpTh extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get single =>
      'ส่งไฟล์ไปยังผู้รับเพียงอุปกรณ์เดียว ไฟล์ที่เลือกไว้จะถูกล้างออกจากรายการทันทีที่โอนไฟล์สำเร็จ';
  @override
  String get multiple =>
      'ส่งไฟล์ไปยังผู้รับหลายอุปกรณ์ ไฟล์ที่เลือกไว้จะไม่ถูกล้างออกจากรายการ';
  @override
  String get link =>
      'ผู้รับที่ไม่ได้ติดตั้งแอป LocalSend สามารถดาวน์โหลดไฟล์ที่เลือกไว้ในรายการได้โดยการเปิดลิงก์ในเบราว์เซอร์';
}

// Path: dialogs.zoom
class _StringsDialogsZoomTh extends _StringsDialogsZoomEn {
  _StringsDialogsZoomTh._(_StringsTh root)
      : this._root = root,
        super._(root);
