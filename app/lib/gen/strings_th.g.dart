...
class _StringsTh extends Translations {
  ...
  @override
  late final _StringsTh _root = this; // ignore: unused_field
  ...
  @override
  late final _StringsGeneralTh general = _StringsGeneralTh._(_root);
  @override
  late final _StringsReceiveTabTh receiveTab = _StringsReceiveTabTh._(_root);
  @override
  late final _StringsSendTabTh sendTab = _StringsSendTabTh._(_root);
  @override
  ...
  @override
  late final _StringsTrayTh tray = _StringsTrayTh._(_root);
  @override
  late final _StringsWebTh web = _StringsWebTh._(_root);
  @override
  late final _StringsAssetPickerTh assetPicker = _StringsAssetPickerTh._(_root);
}

// Path: general
class _StringsGeneralTh extends _StringsGeneralEn {
  _StringsGeneralTh._(_StringsTh root)
      : this._root = root,
        super._(root);

  @override
  final _StringsTh _root; // ignore: unused_field
  ...
  @override
  String get reset => 'ตั้งใหม่';
  @override
  String get restart => 'เริ่มต้นใหม่';
  @override
  String get settings => 'การตั้งค่า';
  @override
  String get skipped => 'ข้ามไป';
  @override
...
class _StringsReceiveTabTh extends _StringsReceiveTabEn {
  _StringsReceiveTabTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabTh extends _StringsSendTabEn {
  _StringsSendTabTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabTh extends _StringsSettingsTabEn {
  _StringsSettingsTabTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageTh extends _StringsTroubleshootPageEn {
  _StringsTroubleshootPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveHistoryPageTh extends _StringsReceiveHistoryPageEn {
  _StringsReceiveHistoryPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsApkPickerPageTh extends _StringsApkPickerPageEn {
  _StringsApkPickerPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsSelectedFilesPageTh extends _StringsSelectedFilesPageEn {
  _StringsSelectedFilesPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsReceivePageTh extends _StringsReceivePageEn {
  _StringsReceivePageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get canceled => 'ผู้ส่งได้ยกเลิกคำขอแล้ว';
}

// Path: receiveOptionsPage
class _StringsReceiveOptionsPageTh extends _StringsReceiveOptionsPageEn {
  _StringsReceiveOptionsPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get saveToGalleryOff => 'ปิดโดยอัตโนมัติเนื่องจากมีไดเร็กทอรี';
}

// Path: sendPage
class _StringsSendPageTh extends _StringsSendPageEn {
  _StringsSendPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get waiting => 'รอการตอบกลับ...';
  @override
  String get rejected => 'ผู้รับได้ปฏิเสธคำขอ';
  @override
  String get busy => 'ผู้รับกำลังยุ่งอยู่กับคำขออื่น';
}

// Path: progressPage
class _StringsProgressPageTh extends _StringsProgressPageEn {
  _StringsProgressPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsWebSharePageTh extends _StringsWebSharePageEn {
  _StringsWebSharePageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsAboutPageTh extends _StringsAboutPageEn {
  _StringsAboutPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get contributors => 'ผู้มีส่วนร่วม';
  @override
  String get translators => 'ผู้แปล';
}

// Path: donationPage
class _StringsDonationPageTh extends _StringsDonationPageEn {
  _StringsDonationPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get restore => 'คืนค่าการซื้อ';
}

// Path: changelogPage
class _StringsChangelogPageTh extends _StringsChangelogPageEn {
  _StringsChangelogPageTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'บันทึกการเปลี่ยนแปลง';
}

// Path: aliasGenerator
class _StringsAliasGeneratorTh extends _StringsAliasGeneratorEn {
  _StringsAliasGeneratorTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsTh extends _StringsDialogsEn {
  _StringsDialogsTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsTrayTh extends _StringsTrayEn {
  _StringsTrayTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get close => 'ออกจาก LocalSend';
}

// Path: web
class _StringsWebTh extends _StringsWebEn {
  _StringsWebTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerTh extends _StringsAssetPickerEn {
  _StringsAssetPickerTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get sActionSwitchPathLabel => 'เปลี่ยนเส้นทาง';
  @override
...
class _StringsReceiveTabInfoBoxTh extends _StringsReceiveTabInfoBoxEn {
  _StringsReceiveTabInfoBoxTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabPickerTh extends _StringsSendTabPickerEn {
  _StringsSendTabPickerTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSendModesTh extends _StringsSendTabSendModesEn {
  _StringsSendTabSendModesTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralTh extends _StringsSettingsTabGeneralEn {
  _StringsSettingsTabGeneralTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get minimizeToTray => 'ออก: ย่อให้เล็กสุดไปยังแถบเทรย์/แถบเมนู';
  @override
  String get launchAtStartup => 'เริ่มอัตโนมัติหลังจากเข้าสู่ระบบ';
  @override
  String get launchMinimized => 'เริ่มอัตโนมัติ: เริ่มซ่อน';
  @override
...
class _StringsSettingsTabReceiveTh extends _StringsSettingsTabReceiveEn {
  _StringsSettingsTabReceiveTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get autoFinish => 'เสร็จสิ้นอัตโนมัติ';
  @override
  String get destination => 'ปลายทาง';
  @override
  String get downloads => '(ดาวน์โหลด)';
  @override
  String get saveToGallery => 'บันทึกมีเดียลงแกลอรี่';
  @override
  String get saveToHistory => 'บันทึกลงในประวัติ';
}

// Path: settingsTab.network
class _StringsSettingsTabNetworkTh extends _StringsSettingsTabNetworkEn {
  _StringsSettingsTabNetworkTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get needRestart => 'เริ่มต้นเซิร์ฟเวอร์ใหม่เพื่อปรับการตั้งค่า!';
  @override
  ...
  String multicastGroupWarning({required Object defaultMulticast}) =>
      'อุปกรณ์อื่นอาจตรวจไม่พบเนื่องจากคุณใช้ที่อยู่มัลติคาสต์แบบกำหนดเอง (default: ${defaultMulticast})';
}

// Path: settingsTab.other
class _StringsSettingsTabOtherTh extends _StringsSettingsTabOtherEn {
  _StringsSettingsTabOtherTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNoConnectionTh extends _StringsTroubleshootPageNoConnectionEn {
  ...
  // Translations
  @override
  String get symptom => 'อุปกรณ์ทั้งสองไม่เจอกันและไม่สามารถแชร์ไฟล์ได้';
  @override
  String get solution =>
      'ปัญหามีอยู่ทั้งสองฝ่าย? จากนั้น คุณต้องตรวจสอบให้แน่ใจว่าอุปกรณ์ทั้งสองอยู่ในเครือข่าย wifi เดียวกันและใช้การกำหนดค่าเดียวกัน (พอร์ต ที่อยู่มัลติคาสต์ การเข้ารหัส) wifi อาจไม่อนุญาตให้มีการสื่อสารระหว่างผู้เข้าร่วม ในกรณีนี้ ต้องเปิดใช้งานตัวเลือกนี้บนเราเตอร์';
}
...
class _StringsProgressPageTotalTh extends _StringsProgressPageTotalEn {
  _StringsProgressPageTotalTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddFileTh extends _StringsDialogsAddFileEn {
  _StringsDialogsAddFileTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get title => 'เพิ่มไปยังส่วนที่เลือก';
  @override
  String get content => 'คุณต้องการจะเพิ่มอะไร?';
}

// Path: dialogs.addressInput
class _StringsDialogsAddressInputTh extends _StringsDialogsAddressInputEn {
  _StringsDialogsAddressInputTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get recentlyUsed => 'ใช้งานล่าสุด: ';
}

// Path: dialogs.cancelSession
class _StringsDialogsCancelSessionTh extends _StringsDialogsCancelSessionEn {
  _StringsDialogsCancelSessionTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCannotOpenFileTh extends _StringsDialogsCannotOpenFileEn {
  _StringsDialogsCannotOpenFileTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsErrorDialogTh extends _StringsDialogsErrorDialogEn {
  _StringsDialogsErrorDialogTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDialogTh extends _StringsDialogsFavoriteDialogEn {
  _StringsDialogsFavoriteDialogTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileInfoTh extends _StringsDialogsFileInfoEn {
  _StringsDialogsFileInfoTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileNameInputTh extends _StringsDialogsFileNameInputEn {
  _StringsDialogsFileNameInputTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String original({required Object original}) => 'ต้นฉบับ: ${original}';
}
...
class _StringsDialogsHistoryClearDialogTh extends _StringsDialogsHistoryClearDialogEn {
  ...
  @override
  String get content => 'คุณต้องการลบประวัติทั้งหมดจริงๆหรือไม่?';
}
...
class _StringsDialogsMessageInputTh extends _StringsDialogsMessageInputEn {
  _StringsDialogsMessageInputTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoFilesTh extends _StringsDialogsNoFilesEn {
  _StringsDialogsNoFilesTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content => 'โปรดเลือกไฟล์อย่างน้อยหนึ่งไฟล์';
}

// Path: dialogs.noPermission
class _StringsDialogsNoPermissionTh extends _StringsDialogsNoPermissionEn {
  _StringsDialogsNoPermissionTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNotAvailableOnPlatformTh extends _StringsDialogsNotAvailableOnPlatformEn {
  ...
  @override
  String get content => 'ฟีเจอร์นี้ใช้งานเฉพาะบน:';
}

// Path: dialogs.qr
class _StringsDialogsQrTh extends _StringsDialogsQrEn {
  _StringsDialogsQrTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickActionsTh extends _StringsDialogsQuickActionsEn {
  _StringsDialogsQuickActionsTh._(_StringsTh root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get sortBeforeCount => 'เรียงตามตัวอักษรไว้ก่อน';
  @override
...
class _StringsDialogsSendModeHelpTh extends _StringsDialogsSendModeHelpEn {
  _StringsDialogsSendModeHelpTh._(_StringsTh root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalTitleTh extends _StringsProgressPageTotalTitleEn {
  ...
  // Translations
  @override
  String sending({required Object time}) => 'ความก้าวคลืบหน้าทั้งหมด (${time})';
  @override
  String get finishedError => 'เสร็จสิ้นมีข้อผิดพลาด';
  @override
  String get canceledSender => 'ยกเลิกโดยผู้ส่ง';
  @override
  String get canceledReceiver => 'ยกเลิกโดยผู้รับ';
}
