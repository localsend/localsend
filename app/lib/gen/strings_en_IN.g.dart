...
class _StringsEnIn extends Translations {
  ...
  @override
  late final _StringsReceiveTabEnIn receiveTab = _StringsReceiveTabEnIn._(_root);
  @override
  late final _StringsSendTabEnIn sendTab = _StringsSendTabEnIn._(_root);
  @override
  late final _StringsSettingsTabEnIn settingsTab = _StringsSettingsTabEnIn._(_root);
  @override
  late final _StringsTroubleshootPageEnIn troubleshootPage = _StringsTroubleshootPageEnIn._(_root);
  @override
  late final _StringsReceiveHistoryPageEnIn receiveHistoryPage = _StringsReceiveHistoryPageEnIn._(_root);
  @override
  late final _StringsApkPickerPageEnIn apkPickerPage = _StringsApkPickerPageEnIn._(_root);
  @override
  late final _StringsSelectedFilesPageEnIn selectedFilesPage = _StringsSelectedFilesPageEnIn._(_root);
  @override
  late final _StringsReceivePageEnIn receivePage = _StringsReceivePageEnIn._(_root);
  @override
  late final _StringsReceiveOptionsPageEnIn receiveOptionsPage = _StringsReceiveOptionsPageEnIn._(_root);
  @override
  late final _StringsSendPageEnIn sendPage = _StringsSendPageEnIn._(_root);
  @override
  late final _StringsProgressPageEnIn progressPage = _StringsProgressPageEnIn._(_root);
  @override
  late final _StringsWebSharePageEnIn webSharePage = _StringsWebSharePageEnIn._(_root);
  @override
  late final _StringsAboutPageEnIn aboutPage = _StringsAboutPageEnIn._(_root);
  @override
  late final _StringsDonationPageEnIn donationPage = _StringsDonationPageEnIn._(_root);
  @override
  late final _StringsChangelogPageEnIn changelogPage = _StringsChangelogPageEnIn._(_root);
  @override
  late final _StringsAliasGeneratorEnIn aliasGenerator = _StringsAliasGeneratorEnIn._(_root);
  @override
  late final _StringsDialogsEnIn dialogs = _StringsDialogsEnIn._(_root);
  @override
  late final _StringsSanitizationEnIn sanitization = _StringsSanitizationEnIn._(_root);
  @override
  late final _StringsTrayEnIn tray = _StringsTrayEnIn._(_root);
  @override
  late final _StringsWebEnIn web = _StringsWebEnIn._(_root);
  @override
  late final _StringsAssetPickerEnIn assetPicker = _StringsAssetPickerEnIn._(_root);
}
...
class _StringsReceiveTabEnIn extends _StringsReceiveTabEn {
  ...
  @override
  late final _StringsReceiveTabInfoBoxEnIn infoBox = _StringsReceiveTabInfoBoxEnIn._(_root);
}
...
class _StringsSendTabEnIn extends _StringsSendTabEn {
  ...
  @override
  late final _StringsSendTabSelectionEnIn selection = _StringsSendTabSelectionEnIn._(_root);
  @override
  late final _StringsSendTabPickerEnIn picker = _StringsSendTabPickerEnIn._(_root);
  @override
  ...
  @override
  late final _StringsSendTabSendModesEnIn sendModes = _StringsSendTabSendModesEnIn._(_root);
  @override
...
class _StringsSettingsTabEnIn extends _StringsSettingsTabEn {
  ...
  @override
  late final _StringsSettingsTabGeneralEnIn general = _StringsSettingsTabGeneralEnIn._(_root);
  @override
  late final _StringsSettingsTabReceiveEnIn receive = _StringsSettingsTabReceiveEnIn._(_root);
  @override
  late final _StringsSettingsTabSendEnIn send = _StringsSettingsTabSendEnIn._(_root);
  @override
  late final _StringsSettingsTabNetworkEnIn network = _StringsSettingsTabNetworkEnIn._(_root);
  @override
  late final _StringsSettingsTabOtherEnIn other = _StringsSettingsTabOtherEnIn._(_root);
  @override
...
class _StringsTroubleshootPageEnIn extends _StringsTroubleshootPageEn {
  ...
  @override
  late final _StringsTroubleshootPageFirewallEnIn firewall = _StringsTroubleshootPageFirewallEnIn._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionEnIn noConnection = _StringsTroubleshootPageNoConnectionEnIn._(_root);
}
...
class _StringsReceiveHistoryPageEnIn extends _StringsReceiveHistoryPageEn {
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsEnIn entryActions = _StringsReceiveHistoryPageEntryActionsEnIn._(_root);
}
...
class _StringsProgressPageEnIn extends _StringsProgressPageEn {
  ...
  @override
  late final _StringsProgressPageTotalEnIn total = _StringsProgressPageTotalEnIn._(_root);
}
...
class _StringsDialogsEnIn extends _StringsDialogsEn {
  ...
  // Translations
  @override
  late final _StringsDialogsAddFileEnIn addFile = _StringsDialogsAddFileEnIn._(_root);
  @override
  late final _StringsDialogsAddressInputEnIn addressInput = _StringsDialogsAddressInputEnIn._(_root);
  @override
  late final _StringsDialogsCancelSessionEnIn cancelSession = _StringsDialogsCancelSessionEnIn._(_root);
  @override
  late final _StringsDialogsCannotOpenFileEnIn cannotOpenFile = _StringsDialogsCannotOpenFileEnIn._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticeEnIn encryptionDisabledNotice = _StringsDialogsEncryptionDisabledNoticeEnIn._(_root);
  @override
  late final _StringsDialogsErrorDialogEnIn errorDialog = _StringsDialogsErrorDialogEnIn._(_root);
  @override
  late final _StringsDialogsFavoriteDialogEnIn favoriteDialog = _StringsDialogsFavoriteDialogEnIn._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogEnIn favoriteDeleteDialog = _StringsDialogsFavoriteDeleteDialogEnIn._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogEnIn favoriteEditDialog = _StringsDialogsFavoriteEditDialogEnIn._(_root);
  @override
  late final _StringsDialogsFileInfoEnIn fileInfo = _StringsDialogsFileInfoEnIn._(_root);
  @override
  late final _StringsDialogsFileNameInputEnIn fileNameInput = _StringsDialogsFileNameInputEnIn._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogEnIn historyClearDialog = _StringsDialogsHistoryClearDialogEnIn._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedEnIn localNetworkUnauthorized = _StringsDialogsLocalNetworkUnauthorizedEnIn._(_root);
  @override
  late final _StringsDialogsMessageInputEnIn messageInput = _StringsDialogsMessageInputEnIn._(_root);
  @override
  late final _StringsDialogsNoFilesEnIn noFiles = _StringsDialogsNoFilesEnIn._(_root);
  @override
  late final _StringsDialogsNoPermissionEnIn noPermission = _StringsDialogsNoPermissionEnIn._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformEnIn notAvailableOnPlatform = _StringsDialogsNotAvailableOnPlatformEnIn._(_root);
  @override
  late final _StringsDialogsQrEnIn qr = _StringsDialogsQrEnIn._(_root);
  @override
  late final _StringsDialogsQuickActionsEnIn quickActions = _StringsDialogsQuickActionsEnIn._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticeEnIn quickSaveNotice = _StringsDialogsQuickSaveNoticeEnIn._(_root);
  @override
  late final _StringsDialogsPinEnIn pin = _StringsDialogsPinEnIn._(_root);
  @override
  late final _StringsDialogsSendModeHelpEnIn sendModeHelp = _StringsDialogsSendModeHelpEnIn._(_root);
  @override
...
class _StringsSettingsTabGeneralEnIn extends _StringsSettingsTabGeneralEn {
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsEnIn brightnessOptions = _StringsSettingsTabGeneralBrightnessOptionsEnIn._(_root);
  @override
  String get color => 'Color';
  @override
  late final _StringsSettingsTabGeneralColorOptionsEnIn colorOptions = _StringsSettingsTabGeneralColorOptionsEnIn._(_root);
  @override
  String get language => 'Language';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsEnIn languageOptions = _StringsSettingsTabGeneralLanguageOptionsEnIn._(_root);
  @override
...
class _StringsProgressPageTotalEnIn extends _StringsProgressPageTotalEn {
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitleEnIn title = _StringsProgressPageTotalTitleEnIn._(_root);
  @override
