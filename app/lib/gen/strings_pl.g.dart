...
class _StringsPl extends Translations {
  ...
  @override
  late final _StringsPl _root = this; // ignore: unused_field
  ...
  @override
  late final _StringsGeneralPl general = _StringsGeneralPl._(_root);
  @override
  late final _StringsReceiveTabPl receiveTab = _StringsReceiveTabPl._(_root);
  @override
  late final _StringsSendTabPl sendTab = _StringsSendTabPl._(_root);
  @override
  late final _StringsSettingsTabPl settingsTab = _StringsSettingsTabPl._(_root);
  @override
  late final _StringsTroubleshootPagePl troubleshootPage =
      _StringsTroubleshootPagePl._(_root);
  @override
  late final _StringsReceiveHistoryPagePl receiveHistoryPage =
      _StringsReceiveHistoryPagePl._(_root);
  @override
  late final _StringsApkPickerPagePl apkPickerPage =
      _StringsApkPickerPagePl._(_root);
  @override
  late final _StringsSelectedFilesPagePl selectedFilesPage =
      _StringsSelectedFilesPagePl._(_root);
  @override
  late final _StringsReceivePagePl receivePage = _StringsReceivePagePl._(_root);
  @override
  late final _StringsReceiveOptionsPagePl receiveOptionsPage =
      _StringsReceiveOptionsPagePl._(_root);
  @override
  late final _StringsSendPagePl sendPage = _StringsSendPagePl._(_root);
  @override
  late final _StringsProgressPagePl progressPage =
      _StringsProgressPagePl._(_root);
  @override
  late final _StringsWebSharePagePl webSharePage =
      _StringsWebSharePagePl._(_root);
  @override
  late final _StringsAboutPagePl aboutPage = _StringsAboutPagePl._(_root);
  @override
  late final _StringsDonationPagePl donationPage =
      _StringsDonationPagePl._(_root);
  @override
  late final _StringsChangelogPagePl changelogPage =
      _StringsChangelogPagePl._(_root);
  @override
  late final _StringsAliasGeneratorPl aliasGenerator =
      _StringsAliasGeneratorPl._(_root);
  @override
  late final _StringsDialogsPl dialogs = _StringsDialogsPl._(_root);
  @override
  late final _StringsSanitizationPl sanitization =
      _StringsSanitizationPl._(_root);
  @override
  late final _StringsTrayPl tray = _StringsTrayPl._(_root);
  @override
  late final _StringsWebPl web = _StringsWebPl._(_root);
  @override
  late final _StringsAssetPickerPl assetPicker = _StringsAssetPickerPl._(_root);
}

// Path: general
class _StringsGeneralPl extends _StringsGeneralEn {
  _StringsGeneralPl._(_StringsPl root)
      : this._root = root,
        super._(root);

  @override
  final _StringsPl _root; // ignore: unused_field
...
class _StringsReceiveTabPl extends _StringsReceiveTabEn {
  _StringsReceiveTabPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsReceiveTabInfoBoxPl infoBox =
      _StringsReceiveTabInfoBoxPl._(_root);
}

// Path: sendTab
class _StringsSendTabPl extends _StringsSendTabEn {
  _StringsSendTabPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSendTabSelectionPl selection =
      _StringsSendTabSelectionPl._(_root);
  @override
  late final _StringsSendTabPickerPl picker = _StringsSendTabPickerPl._(_root);
  @override
  String get shareIntentInfo =>
      'Możesz także skorzystać z funkcji „Udostępnij” swojego urządzenia mobilnego, aby łatwiej wybierać pliki.';
  @override
  ...
  @override
  late final _StringsSendTabSendModesPl sendModes =
      _StringsSendTabSendModesPl._(_root);
  @override
  String get sendModeHelp => 'Wyjaśnienie';
  @override
  String get help =>
      'Upewnij się, że żądany cel również znajduje się w tej samej sieci Wi-Fi.';
  @override
...
class _StringsSettingsTabPl extends _StringsSettingsTabEn {
  _StringsSettingsTabPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSettingsTabGeneralPl general =
      _StringsSettingsTabGeneralPl._(_root);
  @override
  late final _StringsSettingsTabReceivePl receive =
      _StringsSettingsTabReceivePl._(_root);
  @override
  late final _StringsSettingsTabSendPl send =
      _StringsSettingsTabSendPl._(_root);
  @override
  late final _StringsSettingsTabNetworkPl network =
      _StringsSettingsTabNetworkPl._(_root);
  @override
  late final _StringsSettingsTabOtherPl other =
      _StringsSettingsTabOtherPl._(_root);
  @override
...
class _StringsTroubleshootPagePl extends _StringsTroubleshootPageEn {
  _StringsTroubleshootPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get subTitle =>
      'Aplikacja nie działa zgodnie z oczekiwaniami? Tutaj znajdziesz powszechne rozwiązania.';
  @override
  String get solution => 'Rozwiązanie:';
  @override
  String get fixButton => 'Napraw automatycznie';
  @override
  late final _StringsTroubleshootPageFirewallPl firewall =
      _StringsTroubleshootPageFirewallPl._(_root);
  @override
  late final _StringsTroubleshootPageNoDiscoveryPl noDiscovery =
      _StringsTroubleshootPageNoDiscoveryPl._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionPl noConnection =
      _StringsTroubleshootPageNoConnectionPl._(_root);
}

// Path: receiveHistoryPage
class _StringsReceiveHistoryPagePl extends _StringsReceiveHistoryPageEn {
  _StringsReceiveHistoryPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsPl entryActions =
      _StringsReceiveHistoryPageEntryActionsPl._(_root);
}

// Path: apkPickerPage
class _StringsApkPickerPagePl extends _StringsApkPickerPageEn {
  _StringsApkPickerPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String get excludeAppsWithoutLaunchIntent =>
      'Wyklucz aplikacje niewystartowalne';
  @override
...
class _StringsSelectedFilesPagePl extends _StringsSelectedFilesPageEn {
  _StringsSelectedFilesPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsReceivePagePl extends _StringsReceivePageEn {
  _StringsReceivePagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsReceiveOptionsPagePl extends _StringsReceiveOptionsPageEn {
  _StringsReceiveOptionsPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String get saveToGalleryOff =>
      'Wyłączono automatycznie, ponieważ istnieją katalogi.';
}

// Path: sendPage
class _StringsSendPagePl extends _StringsSendPageEn {
  _StringsSendPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPagePl extends _StringsProgressPageEn {
  _StringsProgressPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsProgressPageTotalPl total =
      _StringsProgressPageTotalPl._(_root);
}

// Path: webSharePage
class _StringsWebSharePagePl extends _StringsWebSharePageEn {
  _StringsWebSharePagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String get encryptionHint =>
      'LocalSend używa samopodpisanego certyfikatu. Musisz go zaakceptować w przeglądarce.';
  @override
...
class _StringsAboutPagePl extends _StringsAboutPageEn {
  _StringsAboutPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDonationPagePl extends _StringsDonationPageEn {
  _StringsDonationPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsChangelogPagePl extends _StringsChangelogPageEn {
  _StringsChangelogPagePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsAliasGeneratorPl extends _StringsAliasGeneratorEn {
  _StringsAliasGeneratorPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsPl extends _StringsDialogsEn {
  _StringsDialogsPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  late final _StringsDialogsAddFilePl addFile =
      _StringsDialogsAddFilePl._(_root);
  @override
  late final _StringsDialogsAddressInputPl addressInput =
      _StringsDialogsAddressInputPl._(_root);
  @override
  late final _StringsDialogsCancelSessionPl cancelSession =
      _StringsDialogsCancelSessionPl._(_root);
  @override
  late final _StringsDialogsCannotOpenFilePl cannotOpenFile =
      _StringsDialogsCannotOpenFilePl._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticePl
      encryptionDisabledNotice =
      _StringsDialogsEncryptionDisabledNoticePl._(_root);
  @override
  late final _StringsDialogsErrorDialogPl errorDialog =
      _StringsDialogsErrorDialogPl._(_root);
  @override
  late final _StringsDialogsFavoriteDialogPl favoriteDialog =
      _StringsDialogsFavoriteDialogPl._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogPl favoriteDeleteDialog =
      _StringsDialogsFavoriteDeleteDialogPl._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogPl favoriteEditDialog =
      _StringsDialogsFavoriteEditDialogPl._(_root);
  @override
  late final _StringsDialogsFileInfoPl fileInfo =
      _StringsDialogsFileInfoPl._(_root);
  @override
  late final _StringsDialogsFileNameInputPl fileNameInput =
      _StringsDialogsFileNameInputPl._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogPl historyClearDialog =
      _StringsDialogsHistoryClearDialogPl._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedPl
      localNetworkUnauthorized =
      _StringsDialogsLocalNetworkUnauthorizedPl._(_root);
  @override
  late final _StringsDialogsMessageInputPl messageInput =
      _StringsDialogsMessageInputPl._(_root);
  @override
  late final _StringsDialogsNoFilesPl noFiles =
      _StringsDialogsNoFilesPl._(_root);
  @override
  late final _StringsDialogsNoPermissionPl noPermission =
      _StringsDialogsNoPermissionPl._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformPl notAvailableOnPlatform =
      _StringsDialogsNotAvailableOnPlatformPl._(_root);
  @override
  late final _StringsDialogsQrPl qr = _StringsDialogsQrPl._(_root);
  @override
  late final _StringsDialogsQuickActionsPl quickActions =
      _StringsDialogsQuickActionsPl._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticePl quickSaveNotice =
      _StringsDialogsQuickSaveNoticePl._(_root);
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticePl
      quickSaveFromFavoritesNotice =
      _StringsDialogsQuickSaveFromFavoritesNoticePl._(_root);
  @override
  late final _StringsDialogsPinPl pin = _StringsDialogsPinPl._(_root);
  @override
  late final _StringsDialogsSendModeHelpPl sendModeHelp =
      _StringsDialogsSendModeHelpPl._(_root);
  @override
  late final _StringsDialogsZoomPl zoom = _StringsDialogsZoomPl._(_root);
}

// Path: sanitization
class _StringsSanitizationPl extends _StringsSanitizationEn {
  _StringsSanitizationPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsTrayPl extends _StringsTrayEn {
  _StringsTrayPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsWebPl extends _StringsWebEn {
  _StringsWebPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsAssetPickerPl extends _StringsAssetPickerEn {
  _StringsAssetPickerPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String get unableToAccessAll =>
      'Nie można uzyskać dostępu do wszystkich plików na urządzeniu';
  @override
  String get viewingLimitedAssetsTip =>
      'Przeglądaj tylko pliki i albumy dostępne dla aplikacji.';
  @override
  String get changeAccessibleLimitedAssets =>
      'Kliknij, aby zaktualizować dostępne pliki';
  @override
...
class _StringsReceiveTabInfoBoxPl extends _StringsReceiveTabInfoBoxEn {
  _StringsReceiveTabInfoBoxPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSelectionPl extends _StringsSendTabSelectionEn {
  _StringsSendTabSelectionPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabPickerPl extends _StringsSendTabPickerEn {
  _StringsSendTabPickerPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSendTabSendModesPl extends _StringsSendTabSendModesEn {
  _StringsSendTabSendModesPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralPl extends _StringsSettingsTabGeneralEn {
  _StringsSettingsTabGeneralPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsPl brightnessOptions =
      _StringsSettingsTabGeneralBrightnessOptionsPl._(_root);
  @override
  String get color => 'Kolor';
  @override
  late final _StringsSettingsTabGeneralColorOptionsPl colorOptions =
      _StringsSettingsTabGeneralColorOptionsPl._(_root);
  @override
  String get language => 'Język';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsPl languageOptions =
      _StringsSettingsTabGeneralLanguageOptionsPl._(_root);
  @override
  ...
  String get minimizeToTray =>
      'Zminimalizuj do menu ukrytych ikon przy zamykaniu';
  @override
...
class _StringsSettingsTabReceivePl extends _StringsSettingsTabReceiveEn {
  _StringsSettingsTabReceivePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabSendPl extends _StringsSettingsTabSendEn {
  _StringsSettingsTabSendPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String get shareViaLinkAutoAccept =>
      'Udostępnij przez link: akceptuj automatycznie';
}

// Path: settingsTab.network
class _StringsSettingsTabNetworkPl extends _StringsSettingsTabNetworkEn {
  _StringsSettingsTabNetworkPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String get needRestart =>
      'Uruchom ponownie serwer, aby zastosować ustawienia!';
  @override
...
class _StringsSettingsTabOtherPl extends _StringsSettingsTabOtherEn {
  _StringsSettingsTabOtherPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageFirewallPl
    extends _StringsTroubleshootPageFirewallEn {
  _StringsTroubleshootPageFirewallPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get symptom =>
      'Aplikacja może wysyłać pliki do innych urządzeń, ale inne urządzenia nie mogą wysyłać plików do tego urządzenia.';
  @override
...
class _StringsTroubleshootPageNoDiscoveryPl
    extends _StringsTroubleshootPageNoDiscoveryEn {
  _StringsTroubleshootPageNoDiscoveryPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNoConnectionPl
    extends _StringsTroubleshootPageNoConnectionEn {
  _StringsTroubleshootPageNoConnectionPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get symptom =>
      'Oba urządzenia nie mogą się nawzajem wykryć ani dzielić się plikami.';
  @override
  String get solution =>
...
class _StringsReceiveHistoryPageEntryActionsPl
    extends _StringsReceiveHistoryPageEntryActionsEn {
  _StringsReceiveHistoryPageEntryActionsPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalPl extends _StringsProgressPageTotalEn {
  _StringsProgressPageTotalPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitlePl title =
      _StringsProgressPageTotalTitlePl._(_root);
  @override
...
class _StringsDialogsAddFilePl extends _StringsDialogsAddFileEn {
  _StringsDialogsAddFilePl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsAddressInputPl extends _StringsDialogsAddressInputEn {
  _StringsDialogsAddressInputPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCancelSessionPl extends _StringsDialogsCancelSessionEn {
  _StringsDialogsCancelSessionPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsCannotOpenFilePl extends _StringsDialogsCannotOpenFileEn {
  _StringsDialogsCannotOpenFilePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String content({required Object file}) =>
      'Nie można otworzyć "${file}". Czy ten plik został przeniesiony, zmieniono mu nazwę lub usunięto?';
}

// Path: dialogs.encryptionDisabledNotice
class _StringsDialogsEncryptionDisabledNoticePl
    extends _StringsDialogsEncryptionDisabledNoticeEn {
  _StringsDialogsEncryptionDisabledNoticePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Komunikacja odbywa się teraz za pomocą niezaszyfrowanego protokołu HTTP. Aby korzystać z HTTPS, włącz ponownie szyfrowanie.';
}

// Path: dialogs.errorDialog
class _StringsDialogsErrorDialogPl extends _StringsDialogsErrorDialogEn {
  _StringsDialogsErrorDialogPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDialogPl extends _StringsDialogsFavoriteDialogEn {
  _StringsDialogsFavoriteDialogPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFavoriteDeleteDialogPl
    extends _StringsDialogsFavoriteDeleteDialogEn {
  _StringsDialogsFavoriteDeleteDialogPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  String content({required Object name}) =>
      'Czy na pewno chcesz usunąć z ulubionych "${name}"?';
}

// Path: dialogs.favoriteEditDialog
class _StringsDialogsFavoriteEditDialogPl
    extends _StringsDialogsFavoriteEditDialogEn {
  _StringsDialogsFavoriteEditDialogPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileInfoPl extends _StringsDialogsFileInfoEn {
  _StringsDialogsFileInfoPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsFileNameInputPl extends _StringsDialogsFileNameInputEn {
  _StringsDialogsFileNameInputPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsHistoryClearDialogPl
    extends _StringsDialogsHistoryClearDialogEn {
  _StringsDialogsHistoryClearDialogPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsLocalNetworkUnauthorizedPl
    extends _StringsDialogsLocalNetworkUnauthorizedEn {
  _StringsDialogsLocalNetworkUnauthorizedPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsMessageInputPl extends _StringsDialogsMessageInputEn {
  _StringsDialogsMessageInputPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoFilesPl extends _StringsDialogsNoFilesEn {
  _StringsDialogsNoFilesPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsNoPermissionPl extends _StringsDialogsNoPermissionEn {
  _StringsDialogsNoPermissionPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Nie udzieliłeś wymaganych uprawnień. Udziel ich w ustawieniach.';
}

// Path: dialogs.notAvailableOnPlatform
class _StringsDialogsNotAvailableOnPlatformPl
    extends _StringsDialogsNotAvailableOnPlatformEn {
  _StringsDialogsNotAvailableOnPlatformPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQrPl extends _StringsDialogsQrEn {
  _StringsDialogsQrPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickActionsPl extends _StringsDialogsQuickActionsEn {
  _StringsDialogsQuickActionsPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsQuickSaveNoticePl
    extends _StringsDialogsQuickSaveNoticeEn {
  _StringsDialogsQuickSaveNoticePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Żądania plików są akceptowane automatycznie. Pamiętaj, że każdy w sieci lokalnej może przesyłać Ci pliki.';
}

// Path: dialogs.quickSaveFromFavoritesNotice
class _StringsDialogsQuickSaveFromFavoritesNoticePl
    extends _StringsDialogsQuickSaveFromFavoritesNoticeEn {
  _StringsDialogsQuickSaveFromFavoritesNoticePl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get content =>
      'Żądania plików są akceptowane automatycznie z urządzeń znajdujących się na liście kontaktów.';
}

// Path: dialogs.pin
class _StringsDialogsPinPl extends _StringsDialogsPinEn {
  _StringsDialogsPinPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpPl extends _StringsDialogsSendModeHelpEn {
  _StringsDialogsSendModeHelpPl._(_StringsPl root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get single =>
      'Wysyła pliki do jednego odbiorcy. Wybór zostanie wyczyszczony po zakończonym transferze pliku.';
  @override
  String get multiple =>
      'Wysyła pliki do wielu odbiorców. Wybór nie zostanie wyczyszczony.';
  @override
  String get link =>
      'Odbiorcy, którzy nie mają zainstalowanego LocalSend, mogą pobrać wybrane pliki, otwierając link w swojej przeglądarce.';
}

// Path: dialogs.zoom
class _StringsDialogsZoomPl extends _StringsDialogsZoomEn {
  _StringsDialogsZoomPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralBrightnessOptionsPl
    extends _StringsSettingsTabGeneralBrightnessOptionsEn {
  _StringsSettingsTabGeneralBrightnessOptionsPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralColorOptionsPl
    extends _StringsSettingsTabGeneralColorOptionsEn {
  _StringsSettingsTabGeneralColorOptionsPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsSettingsTabGeneralLanguageOptionsPl
    extends _StringsSettingsTabGeneralLanguageOptionsEn {
  _StringsSettingsTabGeneralLanguageOptionsPl._(_StringsPl root)
      : this._root = root,
        super._(root);
...
class _StringsProgressPageTotalTitlePl
    extends _StringsProgressPageTotalTitleEn {
  _StringsProgressPageTotalTitlePl._(_StringsPl root)
      : this._root = root,
        super._(root);
