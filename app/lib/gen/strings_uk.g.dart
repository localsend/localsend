...
class _StringsDialogsQuickSaveFromFavoritesNoticeUk extends _StringsDialogsQuickSaveFromFavoritesNoticeEn {
	...
	@override String get content => 'Запити на отримання файлів відтепер приймаються автоматично від пристроїв із вашого списку улюблених.';
}
...
class _StringsProgressPageTotalTitleUk extends _StringsProgressPageTotalTitleEn {
	...
	// Translations
	@override String sending({required Object time, required Object speed}) => 'Загальний час передачі (${time}) (${speed})';
