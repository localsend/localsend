...
class _StringsSendTabRu extends _StringsSendTabEn {
  ...
  String get shareIntentInfo =>
      'Вы также можете воспользоваться функцией "Поделиться" на своем мобильном устройстве, чтобы быстрее выбирать файлы.';
  @override
...
class _StringsTroubleshootPageRu extends _StringsTroubleshootPageEn {
  ...
  @override
  String get subTitle =>
      'Приложение не работает должным образом? Здесь вы можете найти некоторые распространенные решения проблем.';
  @override
  ...
  @override
  late final _StringsTroubleshootPageNoDiscoveryRu noDiscovery =
      _StringsTroubleshootPageNoDiscoveryRu._(_root);
  @override
...
class _StringsDialogsRu extends _StringsDialogsEn {
  ...
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticeRu
      quickSaveFromFavoritesNotice =
      _StringsDialogsQuickSaveFromFavoritesNoticeRu._(_root);
  @override
  late final _StringsDialogsPinRu pin = _StringsDialogsPinRu._(_root);
  @override
...
class _StringsAssetPickerRu extends _StringsAssetPickerEn {
  ...
  String get unableToAccessAll =>
      'Не удалось получить доступ ко всем файлам на устройстве';
  @override
  String get viewingLimitedAssetsTip =>
      'Приложение может просматривать только файлы и альбомы, к которым у него есть доступ.';
  @override
...
class _StringsSettingsTabGeneralRu extends _StringsSettingsTabGeneralEn {
  ...
  String get saveWindowPlacementWindows =>
      'Сохранять расположение окна после выхода';
  @override
  String get minimizeToTray =>
      'Сворачивать в системный трей/строку меню при закрытии';
  @override
...
class _StringsSettingsTabSendRu extends _StringsSettingsTabSendEn {
  ...
  String get shareViaLinkAutoAccept =>
      'Автоматически принимать запросы в режиме "Поделиться по ссылке"';
}
...
class _StringsTroubleshootPageNoDiscoveryRu
    extends _StringsTroubleshootPageNoDiscoveryEn {
  _StringsTroubleshootPageNoDiscoveryRu._(_StringsRu root)
      : this._root = root,
        super._(root);
...
class _StringsTroubleshootPageNoConnectionRu
  ...
  @override
  String get symptom =>
      'Оба устройства не могут найти друг друга и не могут обмениваться файлами.';
  @override
  String get solution =>
...
class _StringsDialogsCannotOpenFileRu extends _StringsDialogsCannotOpenFileEn {
  ...
  String content({required Object file}) =>
      'Не удалось открыть "${file}". Возможно, этот файл был перемещен, переименован или удален?';
}
...
class _StringsDialogsEncryptionDisabledNoticeRu
  ...
  @override
  String get content =>
      'Связь теперь происходит по незашифрованному HTTP протоколу. Чтобы использовать протокол HTTPS, снова включите шифрование.';
}
...
class _StringsDialogsQuickSaveFromFavoritesNoticeRu
    extends _StringsDialogsQuickSaveFromFavoritesNoticeEn {
  _StringsDialogsQuickSaveFromFavoritesNoticeRu._(_StringsRu root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsPinRu extends _StringsDialogsPinEn {
  _StringsDialogsPinRu._(_StringsRu root)
      : this._root = root,
        super._(root);
...
class _StringsDialogsSendModeHelpRu extends _StringsDialogsSendModeHelpEn {
  ...
  @override
  String get multiple =>
      'Отправляет файлы нескольким получателям. Выборка не будет очищена после завершения передачи файлов.';
  @override
  String get link =>
...
class _StringsProgressPageTotalTitleRu
  ...
  String sending({required Object time, required Object speed}) =>
      'Общее время передачи (${time}) (${speed})';
  @override
