...
class _StringsMs extends Translations {
  ...
  @override
  late final _StringsTroubleshootPageMs troubleshootPage = _StringsTroubleshootPageMs._(_root);
  @override
  late final _StringsReceiveHistoryPageMs receiveHistoryPage = _StringsReceiveHistoryPageMs._(_root);
  @override
  late final _StringsApkPickerPageMs apkPickerPage = _StringsApkPickerPageMs._(_root);
  @override
  late final _StringsSelectedFilesPageMs selectedFilesPage = _StringsSelectedFilesPageMs._(_root);
  @override
  late final _StringsReceivePageMs receivePage = _StringsReceivePageMs._(_root);
  @override
  late final _StringsReceiveOptionsPageMs receiveOptionsPage = _StringsReceiveOptionsPageMs._(_root);
  @override
  late final _StringsSendPageMs sendPage = _StringsSendPageMs._(_root);
  @override
  late final _StringsProgressPageMs progressPage = _StringsProgressPageMs._(_root);
  @override
  late final _StringsWebSharePageMs webSharePage = _StringsWebSharePageMs._(_root);
  @override
  late final _StringsAboutPageMs aboutPage = _StringsAboutPageMs._(_root);
  @override
  late final _StringsDonationPageMs donationPage = _StringsDonationPageMs._(_root);
  @override
  late final _StringsChangelogPageMs changelogPage = _StringsChangelogPageMs._(_root);
  @override
  late final _StringsAliasGeneratorMs aliasGenerator = _StringsAliasGeneratorMs._(_root);
  @override
  ...
  @override
  late final _StringsSanitizationMs sanitization = _StringsSanitizationMs._(_root);
}
...
class _StringsReceiveTabMs extends _StringsReceiveTabEn {
  ...
  @override
  late final _StringsReceiveTabInfoBoxMs infoBox = _StringsReceiveTabInfoBoxMs._(_root);
}
...
class _StringsSendTabMs extends _StringsSendTabEn {
  ...
  @override
  late final _StringsSendTabSelectionMs selection = _StringsSendTabSelectionMs._(_root);
  @override
  ...
  @override
  late final _StringsSendTabSendModesMs sendModes = _StringsSendTabSendModesMs._(_root);
  @override
...
class _StringsSettingsTabMs extends _StringsSettingsTabEn {
  ...
  @override
  late final _StringsSettingsTabGeneralMs general = _StringsSettingsTabGeneralMs._(_root);
  @override
  late final _StringsSettingsTabReceiveMs receive = _StringsSettingsTabReceiveMs._(_root);
  @override
  late final _StringsSettingsTabSendMs send = _StringsSettingsTabSendMs._(_root);
  @override
  late final _StringsSettingsTabNetworkMs network = _StringsSettingsTabNetworkMs._(_root);
  @override
  late final _StringsSettingsTabOtherMs other = _StringsSettingsTabOtherMs._(_root);
  @override
...
class _StringsTroubleshootPageMs extends _StringsTroubleshootPageEn {
  ...
  @override
  late final _StringsTroubleshootPageFirewallMs firewall = _StringsTroubleshootPageFirewallMs._(_root);
  @override
  late final _StringsTroubleshootPageNoDiscoveryMs noDiscovery = _StringsTroubleshootPageNoDiscoveryMs._(_root);
  @override
  late final _StringsTroubleshootPageNoConnectionMs noConnection = _StringsTroubleshootPageNoConnectionMs._(_root);
}
...
class _StringsReceiveHistoryPageMs extends _StringsReceiveHistoryPageEn {
  ...
  @override
  late final _StringsReceiveHistoryPageEntryActionsMs entryActions = _StringsReceiveHistoryPageEntryActionsMs._(_root);
}
...
class _StringsProgressPageMs extends _StringsProgressPageEn {
  ...
  @override
  late final _StringsProgressPageTotalMs total = _StringsProgressPageTotalMs._(_root);
}
...
class _StringsDialogsMs extends _StringsDialogsEn {
  ...
  // Translations
  @override
  late final _StringsDialogsAddFileMs addFile = _StringsDialogsAddFileMs._(_root);
  @override
  late final _StringsDialogsAddressInputMs addressInput = _StringsDialogsAddressInputMs._(_root);
  @override
  late final _StringsDialogsCancelSessionMs cancelSession = _StringsDialogsCancelSessionMs._(_root);
  @override
  late final _StringsDialogsCannotOpenFileMs cannotOpenFile = _StringsDialogsCannotOpenFileMs._(_root);
  @override
  late final _StringsDialogsEncryptionDisabledNoticeMs encryptionDisabledNotice = _StringsDialogsEncryptionDisabledNoticeMs._(_root);
  @override
  late final _StringsDialogsErrorDialogMs errorDialog = _StringsDialogsErrorDialogMs._(_root);
  @override
  late final _StringsDialogsFileInfoMs fileInfo = _StringsDialogsFileInfoMs._(_root);
  @override
  late final _StringsDialogsFileNameInputMs fileNameInput = _StringsDialogsFileNameInputMs._(_root);
  @override
  late final _StringsDialogsHistoryClearDialogMs historyClearDialog = _StringsDialogsHistoryClearDialogMs._(_root);
  @override
  late final _StringsDialogsLocalNetworkUnauthorizedMs localNetworkUnauthorized = _StringsDialogsLocalNetworkUnauthorizedMs._(_root);
  @override
  late final _StringsDialogsMessageInputMs messageInput = _StringsDialogsMessageInputMs._(_root);
  @override
  late final _StringsDialogsNoFilesMs noFiles = _StringsDialogsNoFilesMs._(_root);
  @override
  late final _StringsDialogsNoPermissionMs noPermission = _StringsDialogsNoPermissionMs._(_root);
  @override
  late final _StringsDialogsNotAvailableOnPlatformMs notAvailableOnPlatform = _StringsDialogsNotAvailableOnPlatformMs._(_root);
  @override
  late final _StringsDialogsQrMs qr = _StringsDialogsQrMs._(_root);
  @override
  late final _StringsDialogsQuickActionsMs quickActions = _StringsDialogsQuickActionsMs._(_root);
  @override
  late final _StringsDialogsQuickSaveNoticeMs quickSaveNotice = _StringsDialogsQuickSaveNoticeMs._(_root);
  @override
  late final _StringsDialogsQuickSaveFromFavoritesNoticeMs quickSaveFromFavoritesNotice = _StringsDialogsQuickSaveFromFavoritesNoticeMs._(_root);
  @override
  late final _StringsDialogsSendModeHelpMs sendModeHelp = _StringsDialogsSendModeHelpMs._(_root);
  @override
  late final _StringsDialogsFavoriteDialogMs favoriteDialog = _StringsDialogsFavoriteDialogMs._(_root);
  @override
  late final _StringsDialogsFavoriteDeleteDialogMs favoriteDeleteDialog = _StringsDialogsFavoriteDeleteDialogMs._(_root);
  @override
  late final _StringsDialogsFavoriteEditDialogMs favoriteEditDialog = _StringsDialogsFavoriteEditDialogMs._(_root);
  @override
...
class _StringsSettingsTabGeneralMs extends _StringsSettingsTabGeneralEn {
  ...
  @override
  late final _StringsSettingsTabGeneralBrightnessOptionsMs brightnessOptions = _StringsSettingsTabGeneralBrightnessOptionsMs._(_root);
  @override
  String get color => 'Warna';
  @override
  late final _StringsSettingsTabGeneralColorOptionsMs colorOptions = _StringsSettingsTabGeneralColorOptionsMs._(_root);
  @override
  String get language => 'Bahasa';
  @override
  late final _StringsSettingsTabGeneralLanguageOptionsMs languageOptions = _StringsSettingsTabGeneralLanguageOptionsMs._(_root);
  @override
...
class _StringsProgressPageTotalMs extends _StringsProgressPageTotalEn {
  ...
  // Translations
  @override
  late final _StringsProgressPageTotalTitleMs title = _StringsProgressPageTotalTitleMs._(_root);
  @override
