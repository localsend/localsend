...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static bool _$quickSaveDialog(SettingsState v) => v.quickSaveDialog;
  static const Field<SettingsState, bool> _f$quickSaveDialog =
      Field('quickSaveDialog', _$quickSaveDialog);
  static bool _$quickSaveFromFavoritesDialog(SettingsState v) =>
      v.quickSaveFromFavoritesDialog;
  static const Field<SettingsState, bool> _f$quickSaveFromFavoritesDialog =
      Field('quickSaveFromFavoritesDialog', _$quickSaveFromFavoritesDialog);
  ...
  final MappableFields<SettingsState> fields = const {
    ...
    #quickSaveDialog: _f$quickSaveDialog,
    #quickSaveFromFavoritesDialog: _f$quickSaveFromFavoritesDialog,
  ...
  static SettingsState _instantiate(DecodingData data) {
    return SettingsState(
        ...
        quickSaveDialog: data.dec(_f$quickSaveDialog),
        quickSaveFromFavoritesDialog: data.dec(_f$quickSaveFromFavoritesDialog),
...
abstract class SettingsStateCopyWith<$R, $In extends SettingsState, $Out>
  ...
  $R call(
      ...
      bool? quickSaveFromFavoritesDialog,
      String? receivePin,
      bool? autoFinish,
      bool? minimizeToTray,
      bool? https,
...
class _SettingsStateCopyWithImpl<$R, $Out>
  ...
  $R call(
      ...
      $apply(FieldCopyWithData({
        ...
        if (quickSaveDialog != null) #quickSaveDialog: quickSaveDialog,
        if (quickSaveFromFavoritesDialog != null)
  ...
  SettingsState $make(CopyWithData data) => SettingsState(
      ...
      quickSaveDialog: data.get(#quickSaveDialog, or: $value.quickSaveDialog),
      quickSaveFromFavoritesDialog: data.get(#quickSaveFromFavoritesDialog,
          or: $value.quickSaveFromFavoritesDialog),
