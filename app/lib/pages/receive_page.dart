                              ...
                              child: Column(
                                ...
                                children: [
                                  if (vm.showSenderInfo && !smallUi)
                                    Padding(padding: const EdgeInsets.only(bottom: 10), child: Icon(vm.sender.deviceType.icon, size: 64)),
                                  Builder(
                                    builder: (context) {
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Card(
                                              child: SingleChildScrollView(
                                                child: Padding(padding: const EdgeInsets.all(10), child: SelectableText(vm.message!)),
                                              ),
                                            ),
                                          ),
                                        ),
