              ...
              children: [
                _BooleanEntry(
                  ...
                  onChanged: (b) async {
                    ...
                    final oldDialog = vm.settings.quickSaveDialog;

                    await ref.notifier(settingsProvider).setQuickSave(b);
                    if (!old && b && context.mounted && !oldDialog) {
                      await ref
                          .notifier(settingsProvider)
                          .setQuickSaveDialog(true);
                ...
                _BooleanEntry(
                  ...
                  onChanged: (b) async {
                    ...
                    final oldFavoriteDialog =
                        vm.settings.quickSaveFromFavoritesDialog;

                    await ref
                        .notifier(settingsProvider)
                        .setQuickSaveFromFavorites(b);
                    if (!old && b && context.mounted && !oldFavoriteDialog) {
                      await ref
                          .notifier(settingsProvider)
                          .setQuickSaveFromFavoritesDialog(true);
                      if (context.mounted) {
