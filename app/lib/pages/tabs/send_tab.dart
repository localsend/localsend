  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder(
      ...
      builder: (context, vm) {
        ...
        if (vm.droppedText != null) {
          vm.onTextDropped(context);
        }
        return DroppableWrapper(
            onDropText: (text) => vm.dropText(text), // Pass the dropped text to the ViewModel
                  ...
                  HorizontalClipListView(
                    ...
                    children: _options.map((option) {
                      return BigButton(
                        ...
                        filled: false,
                        onTap: () async =>
                            ref.global.dispatchAsync(PickFileAction(
                          option: option,
                          context: context,
                        )),
                      );
