...
class PickDirectoryResultMapper extends ClassMapperBase<PickDirectoryResult> {
  ...
  @override
  final MappableFields<PickDirectoryResult> fields = const {#directoryUri: _f$directoryUri, #files: _f$files};
...
class FileInfoMapper extends ClassMapperBase<FileInfo> {
  ...
  @override
  final MappableFields<FileInfo> fields = const {#name: _f$name, #size: _f$size, #uri: _f$uri, #lastModified: _f$lastModified};
